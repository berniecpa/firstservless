...
(function () {
    ...
    function Ya(h, p, D) {
        "millisecond" === D
            ? h.setMilliseconds(h.getMilliseconds() + 1 * p)
            : "second" === D
            ? h.setSeconds(h.getSeconds() + 1 * p)
            : "minute" === D
            ? h.setMinutes(h.getMinutes() + 1 * p)
            : "hour" === D
            ? h.setHours(h.getHours() + 1 * p)
            : "day" === D
            ? h.setDate(h.getDate() + 1 * p)
            : "week" === D
            ? h.setDate(h.getDate() + 7 * p)
            : "month" === D
            ? h.setMonth(h.getMonth() + 1 * p)
            : "year" === D && h.setFullYear(h.getFullYear() + 1 * p);
        return h;
    }
    function $(h, p) {
        var D = !1;
    ...
    function Ta(h, p, D) {
        if (h && p && D) {
            ...
            if ("undefined" !== typeof Blob && new Blob()) {
                for (var F = h.replace(/^data:[a-z\/]*;base64,/, ""), F = atob(F), z = new ArrayBuffer(F.length), z = new Uint8Array(z), v = 0; v < F.length; v++) z[v] = F.charCodeAt(v);
    ...
    function hb(h) {
        if (!ib) {
            ...
            if (h.creditHref && h.creditText) {
                ...
                if (0 === h.renderCount || p || D) h._creditLink.setAttribute("href", h.creditHref), (h._creditLink.innerHTML = h.creditText);
    ...
    function ua(h, p, D) {
        p.getAttribute("state") ||
            ((p.style.backgroundColor = h.toolbar.backgroundColor), (p.style.color = h.toolbar.fontColor), (p.style.border = "none"), sa(h, p, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        p.getAttribute("state") !== D &&
            (p.setAttribute("state", D),
            p.setAttribute("type", "button"),
            sa(h, p, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
    ...
    function V(h, p, D, r, v) {
        ...
        h = {};
        this.theme && u(p) && u(r)
            ? (h = u(ya[this.theme]) ? ya.light1 : ya[this.theme])
            : this.parent &&
              this.parent.themeOptions &&
              this.parent.themeOptions[p] &&
              (null === r ? (h = this.parent.themeOptions[p]) : 0 < this.parent.themeOptions[p].length && ((r = Math.min(this.parent.themeOptions[p].length - 1, r)), (h = this.parent.themeOptions[p][r])));
        this.themeOptions = h;
    ...
    function Aa(h, p) {
        ...
        if (u(this.options.margin) && h.options.subtitles)
            for (var r = h.options.subtitles, za = 0; za < r.length; za++)
                if (
                    ((u(r[za].horizontalAlign) && "center" === this.horizontalAlign) || r[za].horizontalAlign === this.horizontalAlign) &&
                    ((u(r[za].verticalAlign) && "top" === this.verticalAlign) || r[za].verticalAlign === this.verticalAlign) &&
    ...
    var Ja = !1,
        ...
        Ba = {
            colorSet1: "#9a55ff #da8cff #9a55ff #da8cff #9a55ff #da8cff #9a55ff #da8cff #9a55ff #da8cff #9a55ff".split(" "),
    ...
    var X = 20,
        ...
        cb = {
            ...
            data: [{ indexLabelFontFamily: v, indexLabelFontSize: E, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [
                {
                    titleFontFamily: v,
                    titleFontSize: X,
    ...
    Ha = {
        ...
        data: [{ indexLabelFontFamily: v, indexLabelFontSize: E, indexLabelFontColor: Q, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
            {
                titleFontFamily: v,
                titleFontSize: X,
    ...
    (function () {
        ...
        U.obj = { trVs: "Ush`m!Wdsrhno", fntStr: "qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg", txtBl: "udyuC`rdmhod", fnt: "gnou", fSy: "ghmmRuxmd", fTx: "ghmmUdyu", grClr: "fsdx", cntx: "buy", tp: "unq" };
    ...
    var $a = {},
        ...
        ba = function (h, p, r) {
            ...
            O && ((p = Math.floor(h)), (z = -Math.floor(Math.log(h) / Math.LN10 + 1)), (U = 0 === h ? 0 : 0 === p ? -(I + z) : String(p).length - I), (F /= Math.pow(10, U)));
            0 > E && (E = Q);
            F = (h * F).toFixed(N);
            p = F.split(".");
            F = (p[0] + "").split("");
                ...
                if (((p = L.pop()), "#" === p || "0" === p))
                    ...
                    ("E" !== p[0] && "e" !== p[0]) || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p)
                        ? "," === p
                            ...
                            : (r = 1 < p.length && (('"' === p[0] && '"' === p[p.length - 1]) || ("'" === p[0] && "'" === p[p.length - 1])) ? p.slice(1, p.length - 1) + r : p + r)
                ...
                (p = R.shift()),
                    "#" === p || "0" === p
                        ? 0 < h.length && 0 !== Number(h.join(""))
                            ? ((H += h.shift()), (L = !0))
                            : "0" === p && ((H += "0"), (L = !0))
                        : 1 < p.length && (('"' === p[0] && '"' === p[p.length - 1]) || ("'" === p[0] && "'" === p[p.length - 1]))
        ...
        Ra = function (h) {
            var p = 0,
                r = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? ((p = h.offsetX), (r = h.offsetY)) : h.layerX || 0 == h.layerX ? ((p = h.layerX), (r = h.layerY)) : ((p = h.pageX - h.target.offsetLeft), (r = h.pageY - h.target.offsetTop));
            return { x: p, y: r };
        },
        bb = !0,
        ...
        db =
            ...
            (-1 !== window[ja("mnb`uhno")].href.indexOf(ja("b`ow`rkr/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gdonqhy/bnl")) || -1 !== window[ja("mnb`uhno")].href.indexOf(ja("gheemd"))),
    ...
    V.prototype.setOptions = function (h, p) {
        if (ra[this._defaultsKey]) {
            var r = ra[this._defaultsKey],
                u;
            for (u in r) "publicProperties" !== u && r.hasOwnProperty(u) && (this[u] = h && u in h ? h[u] : p && u in p ? p[u] : r[u]);
    ...
    V.prototype.addTo = function (h, p, r, u) {
        ...
        v.hasOwnProperty(h) || (v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readWrite" === v.publicProperties[h])
            ...
            : window.console &&
              (v.publicProperties && v.publicProperties.hasOwnProperty(h) && "readOnly" === v.publicProperties[h]
                  ? window.console.log('Property "' + h + '" is read-only.')
                  : window.console.log('Property "' + h + "\" doesn't exist. Please check for typo."));
    };
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if ((this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray)) {
                ...
                (this.options = "undefined" === typeof h ? {} : h),
                    ...
                    this.optionsName ? (p = this.optionsName) : (p = this._defaultsKey) && 0 !== p.length ? ((r = p.charAt(0).toLowerCase()), 1 < p.length && (r = r.concat(p.slice(1))), (p = r)) : (p = void 0),
                    (h[p] = this.options);
    };
    ...
    V.prototype.addEventListener = function (h, p, r) {
        h && p && ((this._eventListeners[h] = this._eventListeners[h] || []), this._eventListeners[h].push({ context: r || this, eventHandler: p }));
    };
            ...
            for (r = 0; r < this._wrappedText.lines.length; r++)
                (H = this._wrappedText.lines[r]),
                    "right" === this.horizontalAlign
                        ? (u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - H.width / 2 + this.leftPadding)
                        : "left" === this.horizontalAlign
                        ? (u = this.leftPadding)
                        : "center" === this.horizontalAlign && (u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - H.width / 2 + this.leftPadding),
    ...
    ka.prototype._getLineWithWidth = function (h, p, r) {
        ...
        p && ((h = F.split(" ")), 1 < h.length && h.pop(), (F = h.join(" ")), (r = this.ctx.measureText(F).width));
    ...
    Aa.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = p.width - 4 - F * ("center" === this.horizontalAlign ? 2 : 1)), (H = 0.5 * p.height - this.margin - 2), (E = 0))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign || "right" === this.horizontalAlign
                      ? (null === this.maxWidth && (this.maxWidth = p.height - 4), (H = 0.5 * p.width - this.margin - 2))
                      : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = p.width - 4), (H = 0.5 * p.height - 4)));
            var L;
            u(this.padding) || "number" !== typeof this.padding
                ? u(this.padding) ||
                  "object" !== typeof this.padding ||
                  ((L = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0), (L += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0), (L *= 1.25))
                : (L = 2.5 * this.padding);
            ...
            L = H.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((v = p.y1 + 2), (I = "top")) : "bottom" === this.verticalAlign && ((v = p.y2 - 2 - L.height), (I = "bottom")),
                ...
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((r = p.x1 + 2), (v = p.y2 - 2 - (this.maxWidth / 2 - L.width / 2)), (E = -90), (I = "left"), (this.width = L.height), (this.height = L.width))
                      : "right" === this.horizontalAlign
                      ? ((r = p.x2 - 2), (v = p.y1 + 2 + (this.maxWidth / 2 - L.width / 2)), (E = 90), (I = "right"), (this.width = L.height), (this.height = L.width))
                      : "center" === this.horizontalAlign && ((v = h.y1 + (h.height / 2 - L.height / 2)), (r = h.x1 + (h.width / 2 - L.width / 2)), (I = "center"), (this.width = L.width), (this.height = L.height)),
                  (z = "center"));
            H.x = r;
            H.y = v;
            H.angle = E;
            H.horizontalAlign = z;
            this._textBlock = H;
            h.layoutManager.registerSpace(I, { width: this.width + ("left" === I || "right" === I ? this.margin + 2 : 0), height: this.height + ("top" === I || "bottom" === I ? this.margin + 2 : 0) });
    ...
    Na.Chart = (function () {
            ...
            if ((this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId)) {
                ...
                this.canvas.getContext &&
                    ...
                    this.overlaidCanvas.getContext &&
                        (this._canvasJSContainer.appendChild(this.overlaidCanvas), (this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d")), (this.overlaidCanvasCtx.textBaseline = "top"), Ea(this.overlaidCanvasCtx)),
        ...
        function E(a, d, b, c, e, g, k, l, w, m) {
            ...
            a.beginPath();
            w && 0 < l.thickness
                ? (a.moveTo(c - k.thickness / 2, Math.round((b + e) / 2) - q), a.lineTo(d + k.thickness / 2, Math.round((b + e) / 2) - q))
                : 0 < l.thickness && (a.moveTo(Math.round((d + c) / 2) - q, b + k.thickness / 2), a.lineTo(Math.round((d + c) / 2) - q, e - k.thickness / 2));
            a.stroke();
        ...
        function z(a, d, b, c, e, g) {
            ...
            "axisX" === e
                ? ("left" === g || "bottom" === g
                      ? ((this.optionsName = "axisX"), u(this.chart.sessionVariables.axisX[c]) && (this.chart.sessionVariables.axisX[c] = {}), (this.sessionVariables = this.chart.sessionVariables.axisX[c]))
                      : ((this.optionsName = "axisX2"), u(this.chart.sessionVariables.axisX2[c]) && (this.chart.sessionVariables.axisX2[c] = {}), (this.sessionVariables = this.chart.sessionVariables.axisX2[c])),
                  this.options.interval || (this.intervalType = null))
                : "left" === g || "bottom" === g
                ? ((this.optionsName = "axisY"), u(this.chart.sessionVariables.axisY[c]) && (this.chart.sessionVariables.axisY[c] = {}), (this.sessionVariables = this.chart.sessionVariables.axisY[c]))
                : ((this.optionsName = "axisY2"), u(this.chart.sessionVariables.axisY2[c]) && (this.chart.sessionVariables.axisY2[c] = {}), (this.sessionVariables = this.chart.sessionVariables.axisY2[c]));
            ...
            if (this.options.zoomEnabled) {
                if (!this._zoomButton) {
                    ...
                    O(
                        ...
                        function () {
                            d
                                ? (d = !1)
                                : (sa(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                    ...
                    O(
                        ...
                        function () {
                            d ||
                                (sa(a, a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                0 >= navigator.userAgent.search("MSIE") && sa(a, a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                }
                this._resetButton ||
                    ...
                    O(
                        ...
                        function () {
                            d ||
                                (sa(a, a._resetButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.hoverFfontColorOnHoverontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                0 >= navigator.userAgent.search("MSIE") && sa(a, a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                        },
                        this.allDOMEventHandlers
                    ),
                    O(
                        ...
                        function () {
                            d ||
                                (sa(a, a._resetButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                ...
                this.zoomEnabled ||
                    this.panEnabled ||
                    (this._zoomButton
                        ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? ((this.panEnabled = !0), (this.zoomEnabled = !1)) : ((this.zoomEnabled = !0), (this.panEnabled = !1)), Qa(a._zoomButton, a._resetButton))
            ...
            this._menuButton
                ...
                : this.exportEnabled &&
                  ...
                  O(
                      ...
                      function () {
                          d ||
                              (sa(a, a._menuButton, { backgroundColor: a.toolbar.backgroundColorOnHover, color: a.toolbar.fontColorOnHover }),
                              0 >= navigator.userAgent.search("MSIE") && sa(a, a._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                      },
                      this.allDOMEventHandlers,
                      !0
                  ),
                  O(
                      ...
                      function () {
                          d ||
                              (sa(a, a._menuButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor }),
                              0 >= navigator.userAgent.search("MSIE") && sa(a, a._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                      },
                      this.allDOMEventHandlers,
                      !0
                  ));
            ...
            if (this.options.data) {
                for (var b = 0; b < this.options.data.length; b++)
                    if ((a++, !this.options.data[b].type || 0 <= p._supportedChartTypes.indexOf(this.options.data[b].type))) {
                        ...
                        "error" === c.type &&
                            ((c.linkedDataSeriesIndex = u(this.options.data[b].linkedDataSeriesIndex) ? b - 1 : this.options.data[b].linkedDataSeriesIndex),
                        ...
                        "normal" === e
                            ...
                            : null === e && "none" === this.plotInfo.axisPlacement && (g = 'You cannot combine "' + c.type + '" with pie chart');
                        if (g && window.console) {
                        ...
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var b = 0; b < this.options.axisY.length; b++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisY[b] = new z(this, "axisY", this.options.axisY[b], b, "axisY", "left")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[b] = new z(this, "axisY", this.options.axisY[b], b, "axisY", "bottom")));
                            ...
                            this.axisY.length ||
                                ("normal" === this.plotInfo.axisPlacement
                                    ? this._axes.push((this.axisY[0] = new z(this, "axisY", this.options.axisY, 0, "axisY", "left")))
                                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[0] = new z(this, "axisY", this.options.axisY, 0, "axisY", "bottom")))),
                        ...
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (b = 0; b < this.options.axisY2.length; b++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisY2[b] = new z(this, "axisY2", this.options.axisY2[b], b, "axisY", "right")))
                            ...
                            this.axisY2.length ||
                                ("normal" === this.plotInfo.axisPlacement
                                    ? this._axes.push((this.axisY2[0] = new z(this, "axisY2", this.options.axisY2, 0, "axisY", "right")))
                                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY2[0] = new z(this, "axisY2", this.options.axisY2, 0, "axisY", "top")))),
                        ...
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (b = 0; b < this.options.axisX.length; b++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisX[b] = new z(this, "axisX", this.options.axisX[b], b, "axisX", "bottom")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[b] = new z(this, "axisX", this.options.axisX[b], b, "axisX", "left")));
                            ...
                            this.axisX.length ||
                                ("normal" === this.plotInfo.axisPlacement
                                    ? this._axes.push((this.axisX[0] = new z(this, "axisX", this.options.axisX, 0, "axisX", "bottom")))
                                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[0] = new z(this, "axisX", this.options.axisX, 0, "axisX", "left")))),
                        ...
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (b = 0; b < this.options.axisX2.length; b++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisX2[b] = new z(this, "axisX2", this.options.axisX2[b], b, "axisX", "top")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[b] = new z(this, "axisX2", this.options.axisX2[b], b, "axisX", "right")));
                            ...
                            this.axisX2.length ||
                                ("normal" === this.plotInfo.axisPlacement
                                    ? this._axes.push((this.axisX2[0] = new z(this, "axisX2", this.options.axisX2, 0, "axisX", "top")))
                                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[0] = new z(this, "axisX2", this.options.axisX2, 0, "axisX", "right")))),
        ...
        p.prototype.renderElements = function () {
            ...
            this.animatedRender &&
                ...
                b.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: M.fadeInAnimation, easingFunction: M.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 });
            ...
            if (0 < b.length)
                            ...
                            for (var e = 0; e < b.length; e++)
                                (w = b[e]),
                                    1 > a && "undefined" !== typeof w.startTimePercent
                                        ? a >= w.startTimePercent && w.animationCallback(w.easingFunction(a - w.startTimePercent, 0, 1, 1 - w.startTimePercent), w)
                ...
                if (s._breaksCanvas)
                    ...
                    else for (m = 0; m < s._axes.length; m++) s._axes[m].createMask();
                    ...
                    for (w = 0; w < l.dataPoints.length; w++) {
                        ...
                        if (0 < w) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? ((B = e / l.dataPoints[w - 1].y), 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B))
                                    : ((B = e - l.dataPoints[w - 1].y), 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B)));
                        }
                        if (c < n && !m) null !== e && (q = c);
                        else {
                            if (!m && ((m = !0), 0 < w)) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    for (n = 0; n < q.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((r = e / q.dataPoints[n - 1].y), 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r))
                                    : ((r = e - q.dataPoints[n - 1].y), 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)));
                        }
                        if (c < p && !f) null !== q.dataPoints[n].y && (h = c);
                            ...
                            null === q.dataPoints[n].y
                                ? b.viewPortMin === c && h < c && (b.viewPortMin = h)
                                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e), 0 <= e ? (k[c] ? (k[c] += e) : ((k[c] = e), (w = Math.min(e, w)))) : l[c] ? (l[c] += e) : ((l[c] = e), (m = Math.max(e, m))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                        ...
                        (d.dataPointYPositiveSums
                            ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, k), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l))
                            : ((d.dataPointYPositiveSums = k), (d.dataPointYNegativeSums = l)));
                ...
                for (n in k)
                    k.hasOwnProperty(n) &&
                        ...
                        a > d.max && (d.max = a),
                        n < b.viewPortMin || n > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, w)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (n in l)
                    l.hasOwnProperty(n) &&
                        !isNaN(n) &&
                        ((a = l[n]),
                        ...
                        n < b.viewPortMin || n > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, m))));
            }
        };
                    ...
                    for (q = 0; q < s.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            u(e) ||
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((t = e / s.dataPoints[q - 1].y), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e - s.dataPoints[q - 1].y), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
                        }
                        if (c < h && !n) null !== e && (B = c);
                        else {
                            if (!n && ((n = !0), 0 < q)) {
                            ...
                            null === e
                                ...
                                : ((a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + e), 0 <= e ? (k = !0) : 0 > e && (l = !0), (w[c] = w[c] ? w[c] + Math.abs(e) : Math.abs(e)));
                        }
                    }
                    s.axisX.valueType = s.xValueType = g ? "dateTime" : "number";
                }
                a.axisY.logarithmic
                    ? ((d.max = u(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05))), (d.min = u(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
                    : k && !l
                    ? ((d.max = u(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)), (d.min = u(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)))
                    : k && l
                    ? ((d.max = u(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99)), (d.min = u(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)))
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, k, l = !1, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    for (s = 0; s < m.dataPoints.length; s++) {
                        ...
                        0 < s &&
                            (a.axisX.logarithmic
                                ? ((B = c / m.dataPoints[s - 1].x), 1 > B && (B = 1 / B), b.minDiff > B && 1 !== B && (b.minDiff = B))
                                : ((B = c - m.dataPoints[s - 1].x), 0 > B && (B *= -1), b.minDiff > B && 0 !== B && (b.minDiff = B)),
                            e &&
                                null !== e[0] &&
                                m.dataPoints[s - 1].y &&
                                null !== m.dataPoints[s - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((B = e[0] / m.dataPoints[s - 1].y[0]), 1 > B && (B = 1 / B), d.minDiff > B && 1 !== B && (d.minDiff = B))
                                    : ((B = e[0] - m.dataPoints[s - 1].y[0]), 0 > B && (B *= -1), d.minDiff > B && 0 !== B && (d.minDiff = B))));
                        if (!(c < r) || q) {
                            if (!q && ((q = !0), 0 < s)) {
                                s -= 2;
                                f = h;
                ...
                for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    for (w = 0; w < l.dataPoints.length; w++)
                        "undefined" !== typeof l.dataPoints[w].isCumulativeSum && !0 === l.dataPoints[w].isCumulativeSum
                            ? ((l.dataPointEOs[w].cumulativeSumYStartValue = 0), (l.dataPointEOs[w].cumulativeSum = 0 === w ? 0 : l.dataPointEOs[w - 1].cumulativeSum), (l.dataPoints[w].y = 0 === w ? 0 : l.dataPointEOs[w - 1].cumulativeSum))
                            : "undefined" !== typeof l.dataPoints[w].isIntermediateSum && !0 === l.dataPoints[w].isIntermediateSum
                    ...
                    for (w = 0; w < l.dataPoints.length; w++)
                        if (
                            ...
                            0 < w &&
                                (a.axisX.logarithmic
                                    ? ((q = c / l.dataPoints[w - 1].x), 1 > q && (q = 1 / q), b.minDiff > q && 1 !== q && (b.minDiff = q))
                                    : ((q = c - l.dataPoints[w - 1].x), 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q)),
                                null !== e &&
                                    null !== l.dataPoints[w - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = l.dataPointEOs[w].cumulativeSum / l.dataPointEOs[w - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = l.dataPointEOs[w].cumulativeSum - l.dataPointEOs[w - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                            !(c < n) || m)
                        ) {
                            if (!m && ((m = !0), 0 < w)) {
                                w -= 2;
                            ...
                            c > b.viewPortMax && (b.viewPortMax = c);
                            0 < w &&
                                (l.dataPointEOs[w - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[w - 1].cumulativeSum),
        ...
        p.prototype.calculateAutoBreaks = function () {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, m = f.min, l = f.max, k = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, w = 0, s = 0; s < a.dataSeriesIndexes.length; s++) {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (w = 0; w < h.dataPoints.length; w++)
                                    if (
                                        (c &&
                                            ((q = ((l + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                                        ...
                                        if ((g = "waterfall" === a.type ? h.dataPointEOs[w].cumulativeSum : h.dataPoints[w].y) && g.length)
                                            for (var p = 0; p < g.length; p++) (q = Math.floor((g[p] - k) / r)), g[p] < d[q].min && (d[q].min = g[p]), g[p] > d[q].max && (d[q].max = g[p]);
            ...
            for (var c, e = this, g = !1, k = 0; k < this._axes.length; k++)
                if (this._axes[k].scaleBreaks && this._axes[k].scaleBreaks.autoCalculate && 1 <= this._axes[k].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[k].scaleBreaks.collapsibleThreshold) || 10, 10); l++) this._axes[k].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity });
                }
            if (g) {
                        ...
                        if (this._axes[k].scaleBreaks.customBreaks)
                            for (l = 0; l < this._axes[k].scaleBreaks.customBreaks.length; l++)
                                for (c = 0; c < g.length; c++)
                                    if (
                                        (this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue) ||
                                        (this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue) ||
                                        (g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].startValue && this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].end) ||
                                        (g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue && this._axes[k].scaleBreaks.customBreaks[l].endValue <= g[c].end)
                                    )
                                        g.splice(c, 1), c--;
                        g.sort(function (a, c) {
        ...
        p.prototype._dispatchRangeEvent = function (a, d) {
            ...
            for (var e = 0; e < c.length; e++)
                ...
                else if ("axisY2" === c[e]) for (g = 0; g < this.axisY2.length; g++) b[c[e]].push({ viewportMinimum: this[c[e]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][g].sessionVariables.newViewportMaximum });
                else if ("axisX" === c[e]) for (g = 0; g < this.axisX.length; g++) b[c[e]].push({ viewportMinimum: this[c[e]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][g].sessionVariables.newViewportMaximum });
                else if ("axisX2" === c[e]) for (g = 0; g < this.axisX2.length; g++) b[c[e]].push({ viewportMinimum: this[c[e]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[e]][g].sessionVariables.newViewportMaximum });
        ...
        p.prototype._mouseEventHandler = function (a) {
            ...
            p.capturedEventParam &&
                ...
                "mouseup" === b && ((p.capturedEventParam = null), c.chart.overlaidCanvas.releaseCapture ? c.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", c.chart._mouseEventHandler, !1)),
                c.hasOwnProperty(b) &&
                    ("mouseup" !== b || c.chart.overlaidCanvas.releaseCapture ? (a.target !== c.chart.overlaidCanvas && r) || c[b].call(c.context, d.x, d.y) : a.target !== c.chart.overlaidCanvas && (c.chart.isDrag = !1)));
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                else if (
                    (a.preventManipulation && a.preventManipulation(),
                    a.preventDefault && a.preventDefault(),
                    Ja && window.console && (window.console.log(b + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === b && window.console.log("mouseup")),
                    !e)
                ) {
                            ...
                            if (this._events[g].hasOwnProperty(b))
                                if (((c = this._events[g]), (e = c.bounds), d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2)) {
                                    ...
                                    "mousedown" === b && !0 === c.capture
                                        ? ((p.capturedEventParam = c), this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1))
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                            ...
                            (b = this._axes[e]),
                                b.logarithmic
                                    ? b.viewportMinimum < b.minimum
                                        ? ((g = b.minimum / b.viewportMinimum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum * g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum * g), (k = !0))
                                        : b.viewportMaximum > b.maximum &&
                                          ((g = b.viewportMaximum / b.maximum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum / g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum / g), (k = !0))
                                    : b.viewportMinimum < b.minimum
                                    ? ((g = b.minimum - b.viewportMinimum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum + g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum + g), (k = !0))
                                    : b.viewportMaximum > b.maximum &&
                                      ((g = b.viewportMaximum - b.maximum), (b.sessionVariables.newViewportMinimum = b.viewportMinimum - g), (b.sessionVariables.newViewportMaximum = b.viewportMaximum - g), (k = !0));
                    ...
                    k &&
                        ...
                        k && this.zoomEnabled && "none" === this._zoomButton.style.display && (Qa(this._zoomButton, this._resetButton), ua(this, this._zoomButton, "pan"), ua(this, this._resetButton, "reset")));
                }
            }
            this.isDrag = !1;
            if ("none" !== this.plotInfo.axisPlacement) {
                this.resetOverlayedCanvas();
                if (this.axisX && 0 < this.axisX.length) for (k = 0; k < this.axisX.length; k++) this.axisX[k].crosshair && this.axisX[k].crosshair.enabled && this.axisX[k].renderCrosshair(a, d);
                ...
                if (this.axisY2 && 0 < this.axisY2.length) for (k = 0; k < this.axisY2.length; k++) this.axisY2[k].crosshair && this.axisY2[k].crosshair.enabled && this.axisY2[k].renderCrosshair(a, d);
            }
        };
        p.prototype._plotAreaMouseMove = function (a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        (e = { x1: e ? this.plotArea.x1 + b : this.plotArea.x1, y1: g ? this.plotArea.y1 + c : this.plotArea.y1, x2: e ? this.plotArea.x2 + b : this.plotArea.x2, y2: g ? this.plotArea.y2 + c : this.plotArea.y2 }),
                            clearTimeout(k._panTimerId),
                            (k._panTimerId = setTimeout(
                                (function (c, b, e, f) {
                                    return function () {
                                        k._zoomPanToSelectedRegion(c, b, e, f, !0) &&
                                            (k._dispatchRangeEvent("rangeChanging", "pan"), k.render(), k._dispatchRangeEvent("rangeChanged", "pan"), (k.dragStartPoint.x = a), (k.dragStartPoint.y = d));
                                    };
                                })(e.x1, e.y1, e.x2, e.y2),
                                0
                            ));
                        ...
                        this.validateRegion(c, l, e ? a : this.plotArea.x2 - this.plotArea.x1, g ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid &&
            ...
            for (k = 0; k < m.length; k++) {
                ...
                if (isFinite(q.dataInfo.minDiff))
                    if (
                        ...
                        !(
                            g ||
                            (!(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && ((q.logarithmic && B < Math.pow(q.dataInfo.minDiff, 3)) || (!q.logarithmic && B < 3 * Math.abs(q.dataInfo.minDiff)))) ||
                            n < q.minimum ||
                            f > q.maximum
                        ))
                    )
        ...
        p.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a],
                    ...
                    q,
                    n,
                    l = na("indexLabelFontColor", m.dataPoint, m.dataSeries),
                ...
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) C = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: t.total, percent: t.percent };
                ...
                if (null !== x && "" !== x) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== t
                            ? ((e = b.y1),
                              (g = b.y2),
                              0 < ma
                                  ? ((n = m.point.y - w - k - c), n < e && ((n = "auto" === t ? Math.max(m.point.y, e) + k + c : e + k + c), (v = n + w > m.point.y)))
                                  : ((n = m.point.y + k + c), n > g - w - k - c && ((n = "auto" === t ? Math.min(m.point.y, g) - w - k - c : g - w - k - c), (v = n < m.point.y))))
                            : ((e = Math.max(m.bounds.y1, b.y1)),
                              ...
                              0 < ma
                                  ? ((n = Math.max(m.point.y, c) - w / 2), n < e && ("bubble" === s || "scatter" === s) && (n = Math.max(m.point.y - w - k, b.y1 + k)))
                                  : ((n = Math.min(m.point.y, c) - w / 2), n > g - w - k && ("bubble" === s || "scatter" === s) && (n = Math.min(m.point.y + k, b.y2 - w - k))),
                              (n = Math.min(n, g - w)));
                    } else
                        0 <= s.indexOf("line") || 0 <= s.indexOf("area") || 0 <= s.indexOf("scatter") ? ((t = "auto"), (e = 4)) : 0 <= s.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === s && (t = "inside"),
                            (n = m.point.y - w / 2),
                            "inside" !== t
                                ? ((k = b.x1),
                                  (g = b.x2),
                                  0 > ma
                                      ? ((q = m.point.x - l - e - c), q < k && ((q = "auto" === t ? Math.max(m.point.x, k) + e + c : k + e + c), (v = q + l > m.point.x)))
                                      : ((q = m.point.x + e + c), q > g - l - e - c && ((q = "auto" === t ? Math.min(m.point.x, g) - l - e - c : g - l - e - c), (v = q < m.point.x))))
                                : ((k = Math.max(m.bounds.x1, b.x1)),
                                  Math.min(m.bounds.x2, b.x2),
                                  (c =
                                      0 <= s.indexOf("range") || "error" === s
                                          ? 0 > ma
                                              ? Math.max(m.bounds.x1, b.x1) + l / 2 + e
                                              : Math.min(m.bounds.x2, b.x2) - l / 2 - e
                    ...
                    p &&
                        "inside" !== t &&
                        ((0 > s.indexOf("bar") && ("error" !== s || !m.axisSwapped) && m.point.x > b.x1 && m.point.x < b.x2) || !v) &&
                        ((0 > s.indexOf("column") && ("error" !== s || m.axisSwapped) && m.point.y > b.y1 && m.point.y < b.y2) || !v) &&
                        ((d.lineWidth = p),
                        (d.strokeStyle = h ? h : "gray"),
                        d.setLineDash && d.setLineDash(R(B, p)),
                        d.beginPath(),
                        d.moveTo(m.point.x, m.point.y),
                        0 <= s.indexOf("bar") || ("error" === s && m.axisSwapped)
                            ? d.lineTo(q + (0 < m.direction ? 0 : l), n + ("horizontal" === C ? w : -w) / 2)
                            : 0 <= s.indexOf("column") || ("error" === s && !m.axisSwapped)
                            ? d.lineTo(q + l / 2, n + ((0 < m.direction ? w : -w) + ("horizontal" === C ? w : -w)) / 2)
                            : d.lineTo(q + l / 2, n + ((n < m.point.y ? w : -w) + ("horizontal" === C ? w : -w)) / 2),
                        d.stroke());
                }
            }
                            ...
                            if (((C = s[t].x.getTime ? s[t].x.getTime() : s[t].x), !(C < a.axisX.dataInfo.viewPortMin || (C > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u)))))
                                if ("number" !== typeof s[t].y) 0 < t && !(m.connectNullData || u || p) && (b.stroke(), r && c.stroke()), (u = !0);
                                    ...
                                    p || u
                                        ? (!p && m.connectNullData
                                              ? (b.setLineDash &&
                                                    (m.options.nullDataLineDashType || (q === m.lineDashType && m.lineDashType !== m.nullDataLineDashType)) &&
                                                    (b.stroke(), b.beginPath(), b.moveTo(k.x, k.y), (q = m.nullDataLineDashType), b.setLineDash(n)),
                                                b.lineTo(C, x),
                                                r && c.lineTo(C, x))
                                              : (b.beginPath(), b.moveTo(C, x), r && (c.beginPath(), c.moveTo(C, x))),
                                          (u = p = !1))
                                        : (b.lineTo(C, x), r && c.lineTo(C, x), 0 == t % 500 && (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))));
                                    k = { x: C, y: x };
                                    t < s.length - 1 &&
                                        (h !== (s[t].lineColor || B) || q !== (s[t].lineDashType || m.lineDashType)) &&
                                        (b.stroke(),
                                        b.beginPath(),
                                        b.moveTo(C, x),
                                        (h = s[t].lineColor || B),
                                        (b.strokeStyle = h),
                                        b.setLineDash && (s[t].lineDashType ? ((q = s[t].lineDashType), b.setLineDash(R(q, m.lineThickness))) : ((q = m.lineDashType), b.setLineDash(f))));
                                    ...
                                    (s[t].indexLabel || m.indexLabel || s[t].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: s[t], dataSeries: m, point: { x: C, y: x }, direction: 0 > s[t].y === a.axisY.reversed ? 1 : -1, color: B });
                                }
                        b.stroke();
                        r && c.stroke();
                    }
                                ...
                                if ("number" !== typeof s[t].y) 0 < t && !(m.connectNullData || u || p) && (b.stroke(), r && c.stroke()), (u = !0);
                                    ...
                                    p || u
                                        ? (!p && m.connectNullData
                                              ...
                                              : (b.beginPath(), b.moveTo(C, x), r && (c.beginPath(), c.moveTo(C, x))),
                                          (u = p = !1))
                                        : (b.lineTo(C, y), r && c.lineTo(C, y), b.lineTo(C, x), r && c.lineTo(C, x), 0 == t % 500 && (b.stroke(), b.beginPath(), b.moveTo(C, x), r && (c.stroke(), c.beginPath(), c.moveTo(C, x))));
                                    k = { x: C, y: x };
                                    t < s.length - 1 &&
                                        (h !== (s[t].lineColor || B) || q !== (s[t].lineDashType || m.lineDashType)) &&
                                        (b.stroke(),
                                    ...
                                    (s[t].indexLabel || m.indexLabel || s[t].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: s[t], dataSeries: m, point: { x: C, y: x }, direction: 0 > s[t].y === a.axisY.reversed ? 1 : -1, color: B });
                                }
                        b.stroke();
                        r && c.stroke();
                    }
                            ...
                            if (((t = s[p].getTime ? s[p].x.getTime() : s[p].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u)))))
                                if ("number" !== typeof s[p].y)
                                    0 < p &&
                                        !u &&
                                        (m.connectNullData
                                            ? c.setLineDash && 0 < x.length && (m.options.nullDataLineDashType || !s[p - 1].lineDashType) && ((x[x.length - 1].newLineDashArray = n), (q = m.nullDataLineDashType))
                                            : (d(x), (x = []))),
                                        (u = !0);
                                else {
                                    ...
                                    x[x.length] = { x: t, y: u };
                                    p < s.length - 1 &&
                                        (h !== (s[p].lineColor || B) || q !== (s[p].lineDashType || m.lineDashType)) &&
                                        ((h = s[p].lineColor || B),
                                        (x[x.length - 1].newStrokeStyle = h),
                                        c.setLineDash && (s[p].lineDashType ? ((q = s[p].lineDashType), (x[x.length - 1].newLineDashArray = R(q, m.lineThickness))) : ((q = m.lineDashType), (x[x.length - 1].newLineDashArray = f))));
                                    ...
                                    (s[p].indexLabel || m.indexLabel || s[p].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: s[p], dataSeries: m, point: { x: t, y: u }, direction: 0 > s[p].y === a.axisY.reversed ? 1 : -1, color: B });
                                    u = !1;
                                }
                    d(x);
                }
        ...
        p.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                q = this.dataPointWidth = this.options.dataPointWidth
                    ? this.dataPointWidth
                    : (0.9 * ((e.width * (a.axisX.logarithmic ? Math.log(q) / Math.log(a.axisX.range) : Math.abs(q) / Math.abs(a.axisX.range))) / a.plotType.totalDataSeries)) << 0;
                    ...
                    if (0 < B.length)
                        for (var p = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < B.length; g++)
                            if ((B[g].getTime ? (w = B[g].x.getTime()) : (w = B[g].x), !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[g].y)) {
                                ...
                                (B[g].indexLabel || f.indexLabel || B[g].indexLabelFormatter || f.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: k, y1: Math.min(l, t), x2: h, y2: Math.max(l, t) },
                                        color: c,
                                    });
                            }
                }
                    ...
                    if (0 < t.length) {
                        ...
                        for (m = 0; m < t.length; m++)
                            if (((c = t[m].x.getTime ? t[m].x.getTime() : t[m].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y)) {
                                ...
                                (t[m].indexLabel || p.indexLabel || t[m].indexLabelFormatter || p.indexLabelFormatter) &&
                                    this._indexLabels.push({
                        ...
                        for (var u = 5 < f && h.bevelEnabled ? !0 : !1, m = 0; m < t.length; m++)
                            if (((c = t[m].x.getTime ? t[m].x.getTime() : t[m].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y)) {
                                    ...
                                    g[c] = A + (y - q);
                                } else (A = "undefined" !== typeof k[c] ? k[c] : 0), (y = q + A), (q = n + A), a.dataSeriesIndexes.length - 1 === B && 1 >= Math.abs(e.y2 - y) && (y = e.y2), (k[c] = A + (y - q));
                    ...
                    if (0 < t.length) {
                        ...
                        for (m = 0; m < t.length; m++)
                            if (((c = t[m].x.getTime ? t[m].x.getTime() : t[m].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y)) {
                                ...
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[m].y) (w[c] = t[m].y + (w[c] ? w[c] : 0)), (s = k[c] ? k[c] : n), (k[c] = y = a.axisY.convertValueToPixel(w[c]));
                    ...
                    if (0 < t.length) {
                        ...
                        for (m = 0; m < t.length; m++)
                            if (((c = t[m].x.getTime ? t[m].x.getTime() : t[m].x), !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y)) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[m].y) (w[c] = x + (w[c] ? w[c] : 0)), (s = k[c] ? k[c] : n), (k[c] = x = a.axisY.convertValueToPixel(w[c]));
                                ...
                                c = p.dataPointIds[m];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: m, x1: x, y1: v, x2: s, y2: y };
                                c = N(c);
        ...
        p.prototype.renderArea = function (a) {
            ...
            function c() {
                A &&
                    ...
                    g.fill(),
                    (g.globalAlpha = 1),
                    r && (k.lineTo(t, y), k.lineTo(A.x, y), k.closePath(), k.fill()),
                    g.beginPath(),
                    g.moveTo(t, u),
                    k.beginPath(),
                    k.moveTo(t, u),
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var da = !0; h < p.length; h++)
                            if (((x = p[h].x.getTime ? p[h].x.getTime() : p[h].x), !(x < a.axisX.dataInfo.viewPortMin || (x > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !da)))))
                                if ("number" !== typeof p[h].y) B.connectNullData || da || d || c(), (da = !0);
                                    ...
                                    d || da
                                        ? (!d && B.connectNullData
                                              ? (g.setLineDash &&
                                                    (B.options.nullDataLineDashType || (b === B.lineDashType && B.lineDashType !== B.nullDataLineDashType)) &&
                                                    ((d = t), (b = u), (t = q.x), (u = q.y), c(), g.moveTo(q.x, q.y), (t = d), (u = b), (A = q), (b = B.nullDataLineDashType), g.setLineDash(Y)),
                                                g.lineTo(t, u),
                                                r && k.lineTo(t, u))
                                              : (g.beginPath(), g.moveTo(t, u), r && (k.beginPath(), k.moveTo(t, u)), (A = { x: t, y: u })),
                                          (da = d = !1))
                                        : (g.lineTo(t, u), r && k.lineTo(t, u), 0 == h % 250 && c());
                                    q = { x: t, y: u };
                                    h < p.length - 1 &&
                                        (T !== (p[h].lineColor || aa) || b !== (p[h].lineDashType || B.lineDashType)) &&
                                        (c(),
                                        (T = p[h].lineColor || aa),
                                        (g.strokeStyle = T),
                                        g.setLineDash && (p[h].lineDashType ? ((b = p[h].lineDashType), g.setLineDash(R(b, B.lineThickness))) : ((b = B.lineDashType), g.setLineDash(ca))));
                                    var Z = B.dataPointIds[h];
                                    this._eventManager.objectMap[Z] = { id: Z, objectType: "dataPoint", dataSeriesIndex: f, dataPointIndex: h, x1: t, y1: u };
                                    0 !== p[h].markerSize &&
                                        (0 < p[h].markerSize || 0 < B.markerSize) &&
                                        ((x = B.getMarkerProperties(h, t, u, g)), m.push(x), (Z = N(Z)), r && m.push({ x: t, y: u, ctx: k, type: x.type, size: x.size, color: Z, borderColor: Z, borderThickness: x.borderThickness }));
                                    (p[h].indexLabel || B.indexLabel || p[h].indexLabelFormatter || B.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: p[h], dataSeries: B, point: { x: t, y: u }, direction: 0 > p[h].y === a.axisY.reversed ? 1 : -1, color: z });
                                }
                        c();
                        ia.drawMarkers(m);
                    }
                            ...
                            if (((B = n[f].x.getTime ? n[f].x.getTime() : n[f].x), !(B < a.axisX.dataInfo.viewPortMin || (B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !h)))))
                                if ("number" !== typeof n[f].y)
                                    0 < f &&
                                        !h &&
                                        (q.connectNullData
                                            ? c.setLineDash && 0 < x.length && (q.options.nullDataLineDashType || !n[f - 1].lineDashType) && ((x[x.length - 1].newLineDashArray = aa), (z = q.nullDataLineDashType))
                                            : (d(), (x = []))),
                                        (h = !0);
                                else {
                                    ...
                                    f < n.length - 1 &&
                                        ...
                                        c.setLineDash && (n[f].lineDashType ? ((z = n[f].lineDashType), (x[x.length - 1].newLineDashArray = R(z, q.lineThickness))) : ((z = q.lineDashType), (x[x.length - 1].newLineDashArray = T))));
                                    ...
                                    (n[f].indexLabel || q.indexLabel || n[f].indexLabelFormatter || q.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: n[f], dataSeries: q, point: { x: B, y: h }, direction: 0 > n[f].y === a.axisY.reversed ? 1 : -1, color: ma });
                                    h = !1;
                                }
                        d();
                        ia.drawMarkers(l);
                                ...
                                "number" !== typeof h[p].y
                                    ...
                                    : ((t = a.axisX.convertValueToPixel(x)),
                                      ...
                                      d || b
                                          ? (!d && B.connectNullData
                                                ? (g.setLineDash &&
                                                      (B.options.nullDataLineDashType || (Y === B.lineDashType && B.lineDashType !== B.nullDataLineDashType)) &&
                                                      ((d = t), (b = u), (t = q.x), (u = q.y), c(), g.moveTo(q.x, q.y), (t = d), (u = b), (A = q), (Y = B.nullDataLineDashType), g.setLineDash(ca)),
                                                  g.lineTo(t, Z),
                                                  g.lineTo(t, u),
                                                  r && (k.lineTo(t, Z), k.lineTo(t, u)))
                                                : (g.beginPath(), g.moveTo(t, u), r && (k.beginPath(), k.moveTo(t, u)), (A = { x: t, y: u })),
                                            (b = d = !1))
                                          : (g.lineTo(t, Z), r && k.lineTo(t, Z), g.lineTo(t, u), r && k.lineTo(t, u), 0 == p % 250 && c()),
                                      (q = { x: t, y: u }),
                                      p < h.length - 1 &&
                                          (T !== (h[p].lineColor || aa) || Y !== (h[p].lineDashType || B.lineDashType)) &&
                                          (c(),
                                          (T = h[p].lineColor || aa),
                                          (g.strokeStyle = T),
                                          g.setLineDash && (h[p].lineDashType ? ((Y = h[p].lineDashType), g.setLineDash(R(Y, B.lineThickness))) : ((Y = B.lineDashType), g.setLineDash(da)))),
                                      (x = B.dataPointIds[p]),
                                      (this._eventManager.objectMap[x] = { id: x, objectType: "dataPoint", dataSeriesIndex: f, dataPointIndex: p, x1: t, y1: u }),
                                      0 !== h[p].markerSize &&
                                          (0 < h[p].markerSize || 0 < B.markerSize) &&
                                          ((Z = B.getMarkerProperties(p, t, u, g)), m.push(Z), (x = N(x)), r && m.push({ x: t, y: u, ctx: k, type: Z.type, size: Z.size, color: x, borderColor: x, borderThickness: Z.borderThickness })),
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da))))
                                if ("number" !== typeof Z.y) A.connectNullData || da || C || d(), (da = !0);
                                    ...
                                    C || da
                                        ? (!C && A.connectNullData
                                              ? (c.setLineDash &&
                                                    (A.options.nullDataLineDashType || (x === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                                                    ((C = m.pop()), (x = m[m.length - 1]), d(), c.moveTo(t.x, t.y), m.push(x), m.push(C), (x = A.nullDataLineDashType), c.setLineDash(Y)),
                                                c.lineTo(f, h),
                                                r && u.lineTo(f, h))
                                              : (c.beginPath(), c.moveTo(f, h), r && (u.beginPath(), u.moveTo(f, h))),
                                          (da = C = !1))
                                        : (c.lineTo(f, h), r && u.lineTo(f, h), 0 == n % 250 && (d(), c.moveTo(f, h), r && u.moveTo(f, h), m.push({ x: f, y: p - oa })));
                                    t = { x: f, y: h };
                                    n < z.length - 1 &&
                                        ...
                                        (T = z[n].lineColor || aa),
                                        (c.strokeStyle = T),
                                        c.setLineDash && (z[n].lineDashType ? ((x = z[n].lineDashType), c.setLineDash(R(x, A.lineThickness))) : ((x = A.lineDashType), c.setLineDash(ca))));
                                    ...
                                    0 <= A.dataPointIndexes[g] &&
                                        ...
                                        ((oa = A.getMarkerProperties(A.dataPointIndexes[g], f, h, c)),
                                        k.push(oa),
                                        (g = N(la)),
                                        r && k.push({ x: f, y: h, ctx: u, type: oa.type, size: oa.size, color: g, borderColor: g, borderThickness: oa.borderThickness }));
                                    (Z.indexLabel || A.indexLabel || Z.indexLabelFormatter || A.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: Z, dataSeries: A, point: { x: f, y: h }, direction: 0 > z[n].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        c.moveTo(f, h);
                            ...
                            if (!(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da))))
                                if ("number" !== typeof Z.y) A.connectNullData || da || u || d(), (da = !0);
                                    ...
                                    u || da
                                        ? (!u && A.connectNullData
                                              ? (c.setLineDash &&
                                                    (A.options.nullDataLineDashType || (t === A.lineDashType && A.lineDashType !== A.nullDataLineDashType)) &&
                                                    ((u = m.pop()), (t = m[m.length - 1]), d(), c.moveTo(p.x, p.y), m.push(t), m.push(u), (t = A.nullDataLineDashType), c.setLineDash(Y)),
                                                c.lineTo(f, h),
                                                r && x.lineTo(f, h))
                                              : (c.beginPath(), c.moveTo(f, h), r && (x.beginPath(), x.moveTo(f, h))),
                                          (da = u = !1))
                                        : (c.lineTo(f, h), r && x.lineTo(f, h), 0 == n % 250 && (d(), c.moveTo(f, h), r && x.moveTo(f, h), m.push({ x: f, y: C - la })));
                                    p = { x: f, y: h };
                                    n < z.length - 1 &&
                                        ...
                                        (T = z[n].lineColor || aa),
                                        (c.strokeStyle = T),
                                        c.setLineDash && (z[n].lineDashType ? ((t = z[n].lineDashType), c.setLineDash(R(t, A.lineThickness))) : ((t = A.lineDashType), c.setLineDash(ca))));
                                    if (0 <= A.dataPointIndexes[g]) {
                                    ...
                                    0 <= A.dataPointIndexes[g] &&
                                        0 !== Z.markerSize &&
                                        (0 < Z.markerSize || 0 < A.markerSize) &&
                                        ((la = A.getMarkerProperties(n, f, h, c)), l.push(la), (g = N(G)), r && l.push({ x: f, y: h, ctx: x, type: la.type, size: la.size, color: g, borderColor: g, borderThickness: la.borderThickness }));
                                    (Z.indexLabel || A.indexLabel || Z.indexLabelFormatter || A.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: Z, dataSeries: A, point: { x: f, y: h }, direction: 0 > z[n].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        c.moveTo(f, h);
                    ...
                    if (((s = a.dataSeriesIndexes[m]), (q = this.data[s]), (n = q.dataPoints), 0 < n.length))
                        for (b.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++)
                            if (((g = n[e].getTime ? (g = n[e].x.getTime()) : (g = n[e].x)), !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y)) {
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: e, x1: g, y1: k, size: u };
                                u = N(t);
                                r && ia.drawMarker(g, k, this._eventManager.ghostCtx, f.type, f.size, u, u, f.borderThickness);
                                (n[e].indexLabel || q.indexLabel || n[e].indexLabelFormatter || q.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "bubble",
                                        dataPoint: n[e],
                                        dataSeries: q,
                    ...
                    if (0 < s.length) {
                        ...
                        for (var q = 0, n = 0, e = 0; e < s.length; e++)
                            if (((g = s[e].getTime ? (g = s[e].x.getTime()) : (g = s[e].x)), !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[e].y)) {
                                ...
                                b.globalAlpha = 1;
                                (Math.sqrt((q - g) * (q - g) + (n - k) * (n - k)) < Math.min(f.size, 5) && s.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ((q = m.dataPointIds[e]),
                                    (this._eventManager.objectMap[q] = { id: q, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: e, x1: g, y1: k }),
                                    (q = N(q)),
                                    r && ia.drawMarker(f.x, f.y, this._eventManager.ghostCtx, f.type, f.size, q, q, f.borderThickness),
                                    (s[e].indexLabel || m.indexLabel || s[e].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({
                                            chartType: "scatter",
                                            dataPoint: s[e],
                                            dataSeries: m,
                                ...
                                "candlestick" === t.type
                                    ? (b.moveTo(w - D, s),
                                      ...
                                      r &&
                                          ...
                                          c.lineTo(w - D, q),
                                          c.stroke(),
                                          ea(c, z, Math.min(m, n), y, Math.max(m, n), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === t.type &&
                                      (b.moveTo(w - D, s),
                                      b.lineTo(w - D, q),
                                      b.stroke(),
                                      ...
                                      r &&
                                          ...
                                          c.lineTo(y, n),
                                          c.stroke()));
                                (C[l].indexLabel || t.indexLabel || C[l].indexLabelFormatter || t.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: t.type,
                                        dataPoint: C[l],
                                        dataSeries: t,
                ...
                for (var p = !1, p = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < x.length)
                        for (var z = 5 < h && C.bevelEnabled ? !0 : !1, k = 0; k < x.length; k++)
                            if (
                                (x[k].getTime ? (f = x[k].x.getTime()) : (f = x[k].x),
                                !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) &&
                                    !u(x[k].y) &&
                                    x[k].y.length &&
                                    "number" === typeof x[k].y[0] &&
                                    "number" === typeof x[k].y[1] &&
                                    "number" === typeof x[k].y[2] &&
                                    "number" === typeof x[k].y[3] &&
                                    "number" === typeof x[k].y[4] &&
                                    5 === x[k].y.length)
                            ) {
                                ...
                                b.save();
                                0 < la &&
                                    (b.beginPath(), (b.strokeStyle = oa), (b.lineWidth = la), b.setLineDash && b.setLineDash(R(F, la)), b.moveTo(l - G, m), b.lineTo(l - G, w), b.stroke(), b.moveTo(l - G, q), b.lineTo(l - G, s), b.stroke());
                                b.restore();
                                ...
                                r &&
                                    ...
                                    (c.strokeStyle = e),
                                    (c.lineWidth = la),
                                    0 < la && (c.moveTo(l - aa - G, m), c.lineTo(l - aa - G, Math.max(w, q)), c.stroke(), c.moveTo(l - aa - G, Math.min(w, q)), c.lineTo(l - aa - G, s), c.stroke()),
                                    ea(c, y, Math.max(m, s), A, Math.min(m, s), e, 0, null, !1, !1, !1, !1),
                                    0 < Y && (c.beginPath(), (c.lineWidth = Y), c.moveTo(l + da / 2, q - Z), c.lineTo(l - da / 2, q - Z), c.stroke(), c.moveTo(l + da / 2, w + Z), c.lineTo(l - da / 2, w + Z), c.stroke()));
                                (x[k].indexLabel || C.indexLabel || x[k].indexLabelFormatter || C.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: C.type,
                                        dataPoint: x[k],
                                        dataSeries: C,
        ...
        p.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var v = 0, t = 0; t < this.data.length; t++) !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || (this.data[t].type.match(/(stacked)/gi) && v) || v++;
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var x = a.dataSeriesIndexes[C],
                        z = this.data[x],
                        y = z.dataPoints,
                        A = u(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/gi) && z._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (A)
                        for (e = z._linkedSeries.id, t = 0; t < e; t++)
                            !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || (this.data[t].type.match(/(stacked)/gi) && D) || (this.data[t].type.match(/(range)/gi) && (g = !0), D++);
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < y.length)
                        for (var aa = z._colorSet, l = 0; l < y.length; l++) {
                            ...
                            if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !u(y[l].y) && y[l].y.length && "number" === typeof y[l].y[0] && "number" === typeof y[l].y[1]) {
                                ...
                                c ? (q = ca) : (f = ca);
                                c
                                    ? ((n = a.axisX.reversed ? (m + ((A ? v : 1) * t) / 2 - (A ? D - 1 : 0) * t) << 0 : (m - ((A ? v : 1) * t) / 2 + (A ? D - 1 : 0) * t) << 0), (f = a.axisX.reversed ? (n - t) << 0 : (n + t) << 0))
                                    : ((s = a.axisX.reversed ? (w + ((A ? v : 1) * t) / 2 - (A ? D - 1 : 0) * t) << 0 : (w - ((A ? v : 1) * t) / 2 + (A ? D - 1 : 0) * t) << 0), (q = a.axisX.reversed ? (s - t) << 0 : (s + t) << 0));
                                !c && n > f && ((ca = n), (n = f), (f = ca));
                                c && s > q && ((ca = s), (s = q), (q = ca));
                                ca = z.dataPointIds[l];
                                ...
                                if (y[l].indexLabel || z.indexLabel || y[l].indexLabelFormatter || z.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: z,
                                        indexKeyword: 0,
                                        point: { x: c ? (y[l].y[1] >= y[l].y[0] ? s : q) : s + (q - s) / 2, y: c ? n + (f - n) / 2 : y[l].y[1] >= y[l].y[0] ? f : n },
                                        direction: y[l].y[1] >= y[l].y[0] ? -1 : 1,
                                        bounds: { x1: c ? Math.min(s, q) : s, y1: c ? n : Math.min(n, f), x2: c ? Math.max(s, q) : q, y2: c ? f : Math.max(n, f) },
                                        color: e,
                                        axisSwapped: c,
                                    }),
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: z,
                                            indexKeyword: 1,
                                            point: { x: c ? (y[l].y[1] >= y[l].y[0] ? q : s) : s + (q - s) / 2, y: c ? n + (f - n) / 2 : y[l].y[1] >= y[l].y[0] ? n : f },
                                            direction: y[l].y[1] >= y[l].y[0] ? 1 : -1,
                                            bounds: { x1: c ? Math.min(s, q) : s, y1: c ? n : Math.min(n, f), x2: c ? Math.max(s, q) : q, y2: c ? f : Math.max(n, f) },
                                            color: e,
                                            axisSwapped: c,
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (g = 0; g < h.length; g++)
                            if (
                                (h[g].getTime ? (m = h[g].x.getTime()) : (m = h[g].x),
                                ...
                                c = f.dataPointIds[g];
                                this._eventManager.objectMap[c] = { id: c, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: g, x1: k, y1: w, x2: l, y2: v };
                                c = N(c);
                                ...
                                if (h[g].indexLabel || f.indexLabel || h[g].indexLabelFormatter || f.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: f,
                                            indexKeyword: 1,
                                            point: { x: h[g].y[1] >= h[g].y[0] ? l : k, y: w + (v - w) / 2 },
                                            direction: h[g].y[1] >= h[g].y[0] ? 1 : -1,
                                            bounds: { x1: Math.min(k, l), y1: w, x2: Math.max(k, l), y2: v },
                                            color: c,
                                        });
                            ...
                            if (((t = q[f].x.getTime ? q[f].x.getTime() : q[f].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!s.connectNullData || !T)))))
                                if (null !== q[f].y && q[f].y.length && "number" === typeof q[f].y[0] && "number" === typeof q[f].y[1]) {
                                    ...
                                    n || T
                                        ? (s.connectNullData && !n
                                              ? (c.setLineDash &&
                                                    (s.options.nullDataLineDashType || (A === s.lineDashType && s.lineDashType !== s.nullDataLineDashType)) &&
                                                    ((w[w.length - 1].newLineDashArray = D), (A = s.nullDataLineDashType), c.setLineDash(z)),
                                                c.lineTo(h, p),
                                                r && e.lineTo(h, p),
                                                w.push({ x: h, y: u }))
                                              : (c.beginPath(), c.moveTo(h, p), (C = { x: h, y: p }), (w = []), w.push({ x: h, y: u }), r && (e.beginPath(), e.moveTo(h, p))),
                                          (T = n = !1))
                                        : (c.lineTo(h, p), w.push({ x: h, y: u }), r && e.lineTo(h, p), 0 == f % 250 && d());
                                    t = s.dataPointIds[f];
                                    ...
                                    f < q.length - 1 &&
                                        ...
                                        c.setLineDash &&
                                            (q[f].lineDashType
                                                ? ((A = q[f].lineDashType), (w[w.length - 1].newLineDashArray = R(A, s.lineThickness)), c.setLineDash(w[w.length - 1].newLineDashArray))
                                                : ((A = s.lineDashType), (w[w.length - 1].newLineDashArray = D), c.setLineDash(D))));
                                    ...
                                    if (q[f].indexLabel || s.indexLabel || q[f].indexLabelFormatter || s.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: q[f], dataSeries: s, indexKeyword: 0, point: { x: h, y: p }, direction: q[f].y[0] > q[f].y[1] === a.axisY.reversed ? -1 : 1, color: x }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: q[f],
                                                dataSeries: s,
                        ...
                        for (f = !1; q < h.length; q++)
                            if (((n = h[q].x.getTime ? h[q].x.getTime() : h[q].x), !(n < a.axisX.dataInfo.viewPortMin || (n > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !f)))))
                                if (null !== h[q].y && h[q].y.length && "number" === typeof h[q].y[0] && "number" === typeof h[q].y[1]) {
                                    ...
                                    this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: q, x1: n, y1: f, y2: p };
                                    u[u.length] = { x: n, y: f };
                                    z[z.length] = { x: n, y: p };
                                    q < h.length - 1 &&
                                        (x !== (h[q].lineColor || C) || F !== (h[q].lineDashType || m.lineDashType)) &&
                                        ((x = h[q].lineColor || C),
                                        (u[u.length - 1].newStrokeStyle = x),
                                        c.setLineDash && (h[q].lineDashType ? ((F = h[q].lineDashType), (u[u.length - 1].newLineDashArray = R(F, m.lineThickness))) : ((F = m.lineDashType), (u[u.length - 1].newLineDashArray = y))));
                                    if (0 !== h[q].markerSize && (0 < h[q].markerSize || 0 < m.markerSize)) {
                                        var aa = m.getMarkerProperties(q, n, f, c);
                                        g.push(aa);
                                        var T = N(E);
                                        r && g.push({ x: n, y: f, ctx: e, type: aa.type, size: aa.size, color: T, borderColor: T, borderThickness: aa.borderThickness });
                                    ...
                                    if (h[q].indexLabel || m.indexLabel || h[q].indexLabelFormatter || m.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: h[q], dataSeries: m, indexKeyword: 0, point: { x: n, y: f }, direction: h[q].y[0] <= h[q].y[1] ? -1 : 1, color: t }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: h[q], dataSeries: m, indexKeyword: 1, point: { x: n, y: p }, direction: h[q].y[0] <= h[q].y[1] ? 1 : -1, color: t });
                                    f = !1;
                                } else
                                    0 < q &&
                                        !f &&
                                        (m.connectNullData
                                            ? c.setLineDash && 0 < u.length && (m.options.nullDataLineDashType || !h[q - 1].lineDashType) && ((u[u.length - 1].newLineDashArray = A), (F = m.nullDataLineDashType))
                                            : (d(y, C), (u = []), (z = []))),
                                        (f = !0);
                        d(y, C);
                        ia.drawMarkers(g);
                        ...
                        for (var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, k = 0; k < v.length; k++)
                            if ((v[k].getTime ? (s = v[k].x.getTime()) : (s = v[k].x), "number" !== typeof v[k].y)) {
                                ...
                                var Y,
                                    T = l;
                                Y =
                                    ("undefined" !== typeof v[k].isIntermediateSum && !0 === v[k].isIntermediateSum) || ("undefined" !== typeof v[k].isCumulativeSum && !0 === v[k].isCumulativeSum)
                                        ? 0 < v[k].y
                                            ? h
                                            : m
                                        : 0 < v[k].y
                                ...
                                (v[k].indexLabel || u.indexLabel || v[k].indexLabelFormatter || u.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "waterfall",
                                        dataPoint: v[k],
                                        dataSeries: u,
                                        point: { x: l + (F - l) / 2, y: 0 <= v[k].y ? h : m },
        ...
        var ja = function (a, d, b, c, e, g, k, l, h) {
            if (!(0 > b)) {
                ...
                a.globalAlpha = l;
                "pie" === e
                    ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, b, g, k, !1), (a.fillStyle = c), (a.strokeStyle = "white"), (a.lineWidth = 2), a.closePath(), a.fill())
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, b, g, k, !1), 0 <= h && a.arc(d.x, d.y, h * b, k, g, !0), a.closePath(), (a.fillStyle = c), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
                ...
                if (m && s) {
                    for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
                        ...
                        q = g.indexLabelFormatter
                            ...
                            : g.indexLabel
                            ? h.replaceKeywordsWithValue(g.indexLabel, g, m, d)
                            : m.indexLabelFormatter
                            ? m.indexLabelFormatter(p)
                            : m.indexLabel
                            ? h.replaceKeywordsWithValue(m.indexLabel, g, m, d)
                            : g.label
                            ? g.label
                            : "";
                        ...
                        if (k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t) {
                            if (0 === a || f[c].midAngle > k.midAngle) c = d;
                            a++;
            ...
            function b(a) {
                ...
                for (b = 0; b < s.length; b++) {
                    ...
                    if (e > c) {
                        ...
                        } else if (0 < Math.abs(f[b].center.x - x.x) || 0 < Math.abs(f[b].center.y - x.y)) (f[b].center.x = x.x + d * (1 - a)), (f[b].center.y = x.y + g * (1 - a)), (k = !0);
            ...
            function g(a, b, d) {
                ...
                if (0 <= a && a < s.length) {
                    ...
                    var h = 0,
                        ...
                        q = (h = h = 0);
                    0 > b
                        ? n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 > m && n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b < m && (b = -(m - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 + b)))
                        : n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 < m && n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b > l && (b = n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + b - l);
                    ...
                    for (l = 1; l < s.length; l++)
                        if (((m = (a - l + f.length) % f.length), f[m].hemisphere !== f[a].hemisphere)) {
                            ...
                            m !== a &&
                            (0 > c(f[m], f[a]) || ("right" === f[a].hemisphere ? f[m].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[m].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y))
                        )
                            break;
                        else m = null;
                    q = m;
                ...
                for (var b = (a = 0), d = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                            ...
                            if (null !== y) {
                                ...
                                if (0 > z) {
                                    ...
                                    var E = -1 * (z - u),
                                        I = (H = 0);
                                    "right" === l.hemisphere
                                        ? ((H = g(a, u)), (E = -1 * (z - H)), (I = g(y, E)), +I.toFixed(C) < +E.toFixed(C) && +H.toFixed(C) <= +u.toFixed(C) && g(a, -(E - I)))
                                        : ((H = g(y, u)), (E = -1 * (z - H)), (I = g(a, E)), +I.toFixed(C) < +E.toFixed(C) && +H.toFixed(C) <= +u.toFixed(C) && g(y, -(E - I)));
                                }
                            }
                        }
                    } else
                    ...
                    for (a = 0; a < s.length; a++)
                        if (((l = f[a]), (y = l.indexLabelTextBlock.measureText()), 0 !== y.height && 0 !== y.width))
                            (y = y = 0),
                                "right" === l.hemisphere ? ((y = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + q)), (y *= -1)) : (y = n.x1 - (l.indexLabelTextBlock.x - l.indexLabelTextBlock.width - q)),
                                0 < y &&
                                    (!k &&
                                        l.indexLabelText &&
                                        ((u = "right" === l.hemisphere ? n.x2 - l.indexLabelTextBlock.x : l.indexLabelTextBlock.x - n.x1),
                                    ...
                                    Math.abs(l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - x.y) < A || Math.abs(l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 - x.y) < A) &&
                                    ((y /= Math.abs(Math.cos(l.indexLabelAngle))), 9 < y && (y *= 0.3), y > d && (d = y)),
                                (y = y = 0),
                                0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI
                                    ? ((y = n.y2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + 5)), (y *= -1))
                                    : (y = n.y1 - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - 5)),
                                0 < y &&
                                    (!k && l.indexLabelText && ((u = 0 < l.indexLabelAngle && l.indexLabelAngle < Math.PI ? -1 : 1), 0 === g(a, y * u) && g(a, 2 * u)),
                                    Math.abs(l.indexLabelTextBlock.x - x.x) < A && ((y /= Math.abs(Math.sin(l.indexLabelAngle))), 9 < y && (y *= 0.3), y > d && (d = y)));
                    ...
                    this.pieDoughnutClickHandler = function (a) {
                        h.isAnimating ||
                            ...
                            1 < this.dataPoints.length &&
                                h._animator.animate(0, 500, function (a) {
                                    b(a);
                                    l();
                                }));
                    };
        ...
        p.prototype.renderFunnel = function (a) {
                ...
                for (var m = (e[0] = 0), k = 0, n, h, b = b - a, m = !1, l = 0; l < C.length; l++)
                    (a = (Math.abs(C[l].y) * f) / g),
                        m
                            ...
                            : ((h = ba * ba * b * b - 4 * Math.abs(ba) * a),
                              0 > h
                                  ? ((h = c), (m = ((b + h) * (d - k)) / 2), (a -= m), (n = d - k), (k += d - k), (n += 0 == h ? 0 : a / h), (k += a / h), (m = !0))
                                  : ((n = (Math.abs(ba) * b - Math.sqrt(h)) / 2),
                                    (h = b - (2 * n) / Math.abs(ba)),
                                    (k += n),
                                    k > d && ((k -= n), (h = c), (m = ((b + h) * (d - k)) / 2), (a -= m), (n = d - k), (k += d - k), (n += a / h), (k += a / h), (m = !0)),
                                    (b = h))),
                        e.push(n);
                return e;
            }
                ...
                if (t && C) {
                    ...
                    for (var y = 0, A = C.length - 1; y < C.length || 0 <= A; y++, A--) {
                        ...
                        "inside" === t.indexLabelPlacement &&
                            ((p[y] = y !== fa ? (t.reversed ? P[y].x2 - P[y].x1 : P[y].x3 - P[y].x4) : P[y].x3 - P[y].x6),
                            20 > p[y] && ((p[y] = y !== fa ? (t.reversed ? P[y].x3 - P[y].x4 : P[y].x2 - P[y].x1) : P[y].x2 - P[y].x1), (p[y] /= 2)));
                ...
                if (d)
                    for (k = J.length - 1; 0 <= k; k--)
                        (a = P[k]),
                            ...
                            t.reversed
                                ? (J[k].textBlock.y + J[k].height > pa + D && (J[k].textBlock.y = pa + D - J[k].height), J[k].textBlock.y < wa - D && (J[k].textBlock.y = wa - D))
                    ...
                    for (var d = 0; d < P.length; d++)
                        0 == J[d].textBlock.text.length
                            ...
                            : ((a = P[d]),
                              ...
                              t.reversed
                                  ? (J[d].textBlock.y + J[d].height > pa + D && (J[d].textBlock.y = pa + D - J[d].height), J[d].textBlock.y < wa - D && (J[d].textBlock.y = wa - D))
                                  : (J[d].textBlock.y < pa - D && (J[d].textBlock.y = pa - D), J[d].textBlock.y + J[d].height > wa + D && (J[d].textBlock.y = wa + D - J[d].height)));
                else
                    for (d = 0; d < P.length; d++)
                        0 == J[d].textBlock.text.length
                            ...
                            : ((a = P[d]),
                              ...
                              (e = J[d].width),
                              b >= c
                                  ? ((b = d != fa ? (a.x4 + a.x3) / 2 - e / 2 : (a.x5 + a.x4) / 2 - e / 2), (c = d != fa ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2), (J[d].textBlock.x = b), (J[d].textBlock.y = c))
                                  : (J[d].isDirty = !0));
            }
            function k() {
                function a(b, c) {
                    ...
                    for (var l, m = 1; m < k; m++) {
                        ...
                        for (var s = J.length - 1; 0 <= s; s--)
                            !J[s].isDirty &&
                                ...
                                ((l = n(s)), !(l >= J.length - 1) && J[s].textBlock.y + J[s].height + ga > J[l].textBlock.y && (J[s].textBlock.y = J[s].textBlock.y + J[s].height - e > e - J[s].textBlock.y ? e + 1 : e - J[s].height - 1));
                    }
                ...
                for (var d, e, f, g, k, m, h = 1, s = 0; s < 2 * h; s++) {
                    for (
                        ...
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && k && e + d + ga > +m.y.toFixed(6) && ((d = g.y + d + ga - m.y), (e = a(w, -d)), e < d && (0 < e && (d -= e), (e = a(n(w), d)), e != d)));
                        w--
                    );
                    b();
                }
            ...
            function s(a) {
                for (var b, c, d, e, g = 0; g < P.length; g++)
                    (e = 1 === J[g].lineThickness % 2 ? 0.5 : 0),
                        ...
                        J[g].isDirty ||
                            0 == J[g].lineThickness ||
                            ((a.strokeStyle = J[g].lineColor), (a.lineWidth = J[g].lineThickness), a.setLineDash && a.setLineDash(R(J[g].lineDashType, J[g].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke());
            }
            function q(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var t = this.data[a.dataSeriesIndexes[0]], C = t.dataPoints, x = this.plotArea, D = 0.025 * x.width, y = 0.01 * x.width, A = 0, F = x.height - 2 * D, E = Math.min(x.width - 2 * y, 2.8 * x.height), H = !1, I = 0;
                    I < C.length;
                    I++
                )
                    if (
                        (!H && "undefined" !== typeof C[I].indexLabel && null !== C[I].indexLabel && 0 < C[I].indexLabel.toString().length && (H = !0),
                ...
                if (0 != t.length && t.dataPoints && t.visible && 0 !== C.length) {
                    ...
                    "funnel" === t.type
                        ? ((N = u(t.options.neckHeight) ? 0.35 * F : t.neckHeight),
                          ...
                          "string" === typeof N && N.match(/%$/) ? ((N = parseInt(N)), (N = (N * F) / 100)) : (N = parseInt(N)),
                    ...
                    if (-1 !== I) {
                        ...
                        if (t.reversed) for (G = 0; G < I.length; G++) E[G] < Da ? (a.push(K), y.push(ea), (fa = G)) : (a.push((E[G] - pa + ba * $) / ba), y.push((E[G] - pa + ha * V) / ha));
                        else for (G = 0; G < I.length; G++) E[G] < Da ? (a.push((E[G] - pa + ba * $) / ba), y.push((E[G] - pa + ha * V) / ha), (fa = G)) : (a.push(K), y.push(ea));
                        for (G = 0; G < I.length - 1; G++)
                            (X = t.reversed ? (C[C.length - 1 - G].color ? C[C.length - 1 - G].color : t._colorSet[(C.length - 1 - G) % t._colorSet.length]) : C[G].color ? C[G].color : t._colorSet[G % t._colorSet.length]),
                                G === fa
                                    ? P.push({ x1: a[G], y1: E[G], x2: y[G], y2: E[G], x3: ea, y3: Da, x4: y[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1], x6: K, y6: Da, id: G, height: E[G + 1] - E[G], color: X })
                                    : P.push({ x1: a[G], y1: E[G], x2: y[G], y2: E[G], x3: y[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: X });
                        var ga = 2,
                            J = [],
                            ja = !1,
                            W = [],
                ...
                if ("x" === a)
                    if ("dateTime" === b.axisX.valueType || "dateTime" === b.xValueType || (d.x && d.x.getTime)) {
                        if (g.plotInfo.plotTypes[0].plotUnits[0].axisX && !g.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
                            return Ca(
                                f,
                                d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : (b.xValueFormatString = g.axisX && g.axisX.autoValueFormatString ? g.axisX.autoValueFormatString : "DD MMM YY"),
                                g._cultureInfo
                            );
                    ...
                    return "y" === a
                        ? ba(f, d.yValueFormatString ? d.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : (b.yValueFormatString = "#,##0.########"), g._cultureInfo)
                        : "z" === a
                        ? ba(f, d.zValueFormatString ? d.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : (b.zValueFormatString = "#,##0.########"), g._cultureInfo)
                        : f;
            });
        };
        qa(H, V);
        H.prototype.setLayout = function () {
            ...
            var h = [],
                m = [];
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ((this.orientation = "horizontal"), (b = this.verticalAlign), (g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width), (k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height))
                : "center" === this.verticalAlign &&
                  ((this.orientation = "vertical"), (b = this.horizontalAlign), (g = this.maxWidth = null !== this.maxWidth ? this.maxWidth : 0.5 * d.width), (k = this.maxHeight = null !== this.maxHeight ? this.maxHeight : d.height));
                ...
                if (q.dataPoints && q.dataPoints.length)
                    if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                        var n = (q.legendMarkerType = q.legendMarkerType
                                ? q.legendMarkerType
                                : ("line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type) || !q.markerType
                                ...
                                : q.markerType),
                            f = q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: q, dataPoint: null }) : q.name,
                        ...
                        for (var z = 0; z < q.dataPoints.length; z++) {
                            var x = q.dataPoints[z],
                                ...
                                f = x.legendText
                                    ...
                                    ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: q, dataPoint: x })
                                    : x.name
                                    ? x.name
                                    : "DataPoint: " + (z + 1),
                    ...
                    if (!(0 >= k || "undefined" === typeof k || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (
                                !q ||
                                q.width +
                                    Math.round(n.textBlock.width + r + l + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                                    g
                            )
                            ...
                            (n.textBlock = new ka(this.ctx, {
                                ...
                                n.textBlock.measureText(),
                                null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (r + l + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                                this.height < k - this.lineHeight ? ((q = { items: [], width: 0 }), m.push(q)) : ((q = m[z]), (z = (z + 1) % m.length)),
            ...
            "none" !== this.chart.plotInfo.axisPlacement &&
                (this.axisX.logarithmic
                    ? ((s = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
                      (s = 1 < s ? Math.min(Math.max((((this.dataPoints.length - 1) / s) * Math.log(a / this.dataPoints[0].x)) >> 0, 0), this.dataPoints.length) : 0))
                    : ((s = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x), (s = 0 < s ? Math.min(Math.max((((this.dataPoints.length - 1) / s) * (a - this.dataPoints[0].x)) >> 0, 0), this.dataPoints.length) : 0)));
            for (;;) {
                g = 0 < k ? s + e : s - e;
        ...
        F.prototype.getDataPointAtXY = function (a, d, b) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                ...
                else (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x), (q = 0 < n ? Math.min(Math.max((((this.dataPoints.length - 1) / n) * (q - this.dataPoints[0].x)) >> 0, 0), this.dataPoints.length) : 0);
            for (;;) {
                g = 0 < k ? q + e : q - e;
                if (0 <= g && g < this.dataPoints.length) {
                        ...
                        switch (this.type) {
                            ...
                            case "error":
                                a >= n.x1 &&
                                    ...
                                    d >= n.y1 &&
                                    d <= n.y2 &&
                                    (c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y1 - d), Math.abs(n.y2 - d)) }), (l = !0));
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "doughnut":
                                ...
                                p < n.radius &&
                                    ...
                                    p > u && p < r && (c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: 0 }), (l = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                p = n.funnelSection;
                                d > p.y1 &&
                                    ...
                                    (p.y6
                                        ? d > p.y6
                                            ? ((g = p.x6 + ((p.x5 - p.x6) / (p.y5 - p.y6)) * (d - p.y6)), (p = p.x3 + ((p.x4 - p.x3) / (p.y4 - p.y3)) * (d - p.y3)))
                                            : ((g = p.x1 + ((p.x6 - p.x1) / (p.y6 - p.y1)) * (d - p.y1)), (p = p.x2 + ((p.x3 - p.x2) / (p.y3 - p.y2)) * (d - p.y2)))
                                        : ((g = p.x1 + ((p.x4 - p.x1) / (p.y4 - p.y1)) * (d - p.y1)), (p = p.x2 + ((p.x3 - p.x2) / (p.y3 - p.y2)) * (d - p.y2))),
                                    a > g && a < p && (c.push({ dataPoint: f, dataPointIndex: n.dataPointIndex, dataSeries: this, distance: 0 }), (l = !0)));
                                break;
                            case "boxAndWhisker":
                                if (
                                    (a >= n.x1 - n.borderThickness / 2 && a <= n.x2 + n.borderThickness / 2 && d >= n.y4 - n.borderThickness / 2 && d <= n.y1 + n.borderThickness / 2) ||
                            ...
                            case "candlestick":
                                if (
                                    (a >= n.x1 - n.borderThickness / 2 && a <= n.x2 + n.borderThickness / 2 && d >= n.y2 - n.borderThickness / 2 && d <= n.y3 + n.borderThickness / 2) ||
                                    (Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness && d >= n.y1 && d <= n.y4)
                                )
                                    c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y2 - d), Math.abs(n.y3 - d)) }), (l = !0);
                                break;
                            case "ohlc":
                                if (
                                    ...
                                    (a >= n.x1 && a <= (n.x2 + n.x1) / 2 && d >= n.y1 - n.borderThickness / 2 && d <= n.y1 + n.borderThickness / 2) ||
                                    (a >= (n.x1 + n.x2) / 2 && a <= n.x2 && d >= n.y4 - n.borderThickness / 2 && d <= n.y4 + n.borderThickness / 2)
                                )
                                    c.push({ dataPoint: f, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(n.x1 - a), Math.abs(n.x2 - a), Math.abs(n.y2 - d), Math.abs(n.y3 - d)) }), (l = !0);
                        }
        ...
        z.prototype.createLabels = function () {
                ...
                (l =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ? (this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
                          Math.log(this.range)
                        : (this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * S[this.intervalType + "Duration"] * this.interval),
                ...
                (l =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ? (this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
                          Math.log(this.range)
                        : (this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * S[this.intervalType + "Duration"] * this.interval),
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (
                                ...
                                if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ((this.sessionVariables.labelMaxHeight =
                                            0 === this.labelAngle ? k : Math.min((c - g * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)), c)),
                                        ...
                                        this.labelWrap
                                            ...
                                            ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                              (this.sessionVariables.labelMaxHeight = k),
                                              (this.sessionVariables.labelMaxWidth = g),
                                              (B.width + d.width) >> 0 > 2 * g && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p)))
                                            : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > g ? -25 : this.sessionVariables.labelAngle),
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                              (this.sessionVariables.labelMaxHeight = k),
                                              (this.sessionVariables.labelWrap = this.labelWrap));
                                        ...
                                        if (u(this.options.labelWrap))
                                            if (!u(this.options.labelMaxWidth))
                                                this.options.labelMaxWidth < g
                                                    ...
                                                    : ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth), (this.sessionVariables.labelMaxHeight = k));
                                            else if (!u(d))
                                                if (((c = (B.width + d.width) >> 0), (f = this.labelFontSize), n < g))
                                                    c - 2 * g > q &&
                                                        ...
                                                        c >= 2 * g && c < 2.2 * g
                                                            ? ((this.sessionVariables.labelMaxWidth = g),
                                                              u(this.options.labelFontSize) && 12 < f && ((f = Math.floor((12 / 13) * f)), a.measureText()),
                                                              (this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? f : this.options.labelFontSize),
                                                              (this.sessionVariables.labelAngle = this.labelAngle))
                                                            : c >= 2.2 * g && c < 2.8 * g
                                                            ? ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = p), (this.sessionVariables.labelFontSize = f))
                                                            : c >= 2.8 * g && c < 3.2 * g
                                                            ? ((this.sessionVariables.labelMaxWidth = Math.max(g, n)),
                                                              (this.sessionVariables.labelWrap = !0),
                                                              u(this.options.labelFontSize) && 12 < this.labelFontSize && ((this.labelFontSize = Math.floor((12 / 13) * this.labelFontSize)), a.measureText()),
                                                              (this.sessionVariables.labelFontSize = u(this.options.labelFontSize) ? f : this.options.labelFontSize),
                                                              (this.sessionVariables.labelAngle = this.labelAngle))
                                                            : c >= 3.2 * g && c < 3.6 * g
                                                    ...
                                                    v === b &&
                                                    ((0 === v && n + this._labels[v + 1].textBlock.measureText().width - 2 * g > q) ||
                                                        (v === this._labels.length - 1 && n + this._labels[v - 1].textBlock.measureText().width - 2 * g > q) ||
                                                        (0 < v && v < this._labels.length - 1 && n + this._labels[v + 1].textBlock.measureText().width - 2 * g > q && n + this._labels[v - 1].textBlock.measureText().width - 2 * g > q))
                                                )
                                    ...
                                    (this.sessionVariables.labelMaxHeight = k = this.labelWrap
                                        ? (m - p * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                                    ...
                                    u(this.options.labelWrap))
                                        ...
                                        : (this.options.labelWrap
                                              ...
                                              : (u(this.options.labelMaxWidth), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : p), (this.sessionVariables.labelWrap = this.labelWrap)),
                                          (this.sessionVariables.labelMaxHeight = k));
                            }
                        for (c = 0; c < this._labels.length; c++)
                            (a = this._labels[c].textBlock),
                    ...
                    if (
                        ((g = u(this.options.labelMaxWidth) ? (0.3 * this.chart.width) >> 0 : this.options.labelMaxWidth),
                        (k = "undefined" === typeof this.options.labelWrap || this.labelWrap ? (0.3 * this.chart.height) >> 0 : 1.5 * this.labelFontSize),
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            if (!this._labels[b].breaksLabelType) {
                                ...
                                Math.cos((Math.PI / 180) * Math.abs(this.labelAngle));
                                Math.sin((Math.PI / 180) * Math.abs(this.labelAngle));
                                u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                                    ? u(this.options.labelWrap)
                                        ? u(this.options.labelWrap) &&
                                          (u(this.options.labelMaxWidth)
                                              ? u(d) ||
                                                ...
                                                l - 2 * k > n &&
                                                    ...
                                                    l >= 2 * k && l < 2.4 * k
                                                        ...
                                                        : l > 10 * k &&
                                                          ...
                                                          (this.sessionVariables.labelMaxWidth = g),
                                                          (this.sessionVariables.labelAngle = u(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))))
                                              : ((this.sessionVariables.labelMaxHeight = k), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)))
                                    ...
                                    ? u(this.options.labelWrap) &&
                                      (this.labelWrap && !u(this.options.labelMaxWidth)
                                          ...
                                          : ((this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : g),
                                            (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : c),
                                            u(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle)))
                                    : this.options.labelWrap
                                    ? ((this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : c), (this.sessionVariables.labelWrap = this.labelWrap), (this.sessionVariables.labelMaxWidth = g))
                                    : ((this.sessionVariables.labelMaxHeight = k),
                                      u(this.options.labelMaxWidth),
            ...
            if ("normal" === e) {
                for (var C = [], x = [], D = [], y = [], M = [], N = [], O = [], Q = []; 4 > v; ) {
                    var G = 0,
                        ...
                        P = 0,
                        ba = 0;
                    if (b && 0 < b.length) for (D = [], f = P = 0; f < b.length; f++) D.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateWidth() : 0)), (P += D[f]), (K += b[f] && !p.isNavigator ? b[f].margin : 0);
                    else D.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    O.push(D);
                    if (c && 0 < c.length) for (y = [], f = ba = 0; f < c.length; f++) y.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateWidth() : 0)), (ba += y[f]), ($ += c[f] ? c[f].margin : 0);
                        ...
                        for (f = 0; f < a.length; f++)
                            a[f] &&
                                ...
                                !a[f] ||
                                    ...
                                    ((l = 0),
                                    0 < a[f].labelAngle
                                        ? E + t > h && (l += 0 < a[f].labelAngle ? E + t - h - ba : 0)
                                        : 0 > a[f].labelAngle
                                        ? A - z < k && A - z < a[f].viewportMinimum && (F = k - (K + a[f].tickLength + D + A - z + a[f].labelFontSize / 2))
                                        : 0 === a[f].labelAngle && (E + t > h && (l = E + t / 2 - h - ba), A - z < k && A - z < a[f].viewportMinimum && (F = k - K - a[f].tickLength - D - A + z / 2)),
                                    a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < l
                                        ? (h -= l)
                                        : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 > a[f].labelAngle && 0 < F
                                        ? (k += F)
                                        : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < F && (k += F), 0 < l && (h -= l))),
                                ...
                                (a[f].bounds = { x1: k, y1: l, x2: h, y2: m - (V + e - C[f] - G), width: h - k, height: m - l })),
                                (G += C[f] + a[f].margin);
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++)
                            (d[f].lineCoordinates.x1 = Math.round(g.x1 + P + K)),
                                ...
                                (d[f].bounds = { x1: k, y1: l + (X + W - x[f] - R), x2: h, y2: m, width: h - k, height: m - l }),
                                (R += x[f] + d[f].margin);
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            (K = p.isNavigator ? 0 : 10),
                                b[f] &&
                                    ...
                                    (b[f].lineCoordinates = { x1: h - S, y1: l, x2: h - S, y2: m, height: Math.abs(m - l) }),
                                    (b[f].bounds = { x1: k - (D[f] + S), y1: l, x2: h, y2: m, width: h - k, height: m - l }),
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            c[f] &&
                                ((k = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2)),
                                (h = Math.round(k)),
                                ...
                                (m = Math.round(g.y2 - (V + e + K))),
                                (c[f].lineCoordinates = { x1: k + U, y1: l, x2: k + U, y2: m, height: Math.abs(m - l) }),
                                (c[f].bounds = { x1: k, y1: l, x2: h + (y[f] + U), y2: m, width: h - k, height: m - l }),
                        ...
                        for (f = 0; f < a.length; f++)
                            a[f] &&
                                ...
                                a[f]._labels &&
                                    1 < a[f]._labels.length &&
                                    ((A =
                                        (a[f].logarithmic ? Math.log(a[f]._labels[1].position / a[f].viewportMinimum) / a[f].conversionParameters.lnLogarithmBase : a[f]._labels[1].position - a[f].viewportMinimum) *
                                    ...
                                    (E = a[f].logarithmic
                                        ? (1 < k ? (Math.log(k) / a[f].conversionParameters.lnLogarithmBase) * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1
                                        : (0 < k ? k * Math.abs(a[f].conversionParameters.pixelPerUnit) : 0) + a[f].lineCoordinates.x1)));
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++)
                            d[f].calculateValueToPixelConversionParameters(),
                                ...
                                d[f]._labels &&
                                    1 < d[f]._labels.length &&
                                    ((A =
                                        (d[f].logarithmic ? Math.log(d[f]._labels[1].position / d[f].viewportMinimum) / d[f].conversionParameters.lnLogarithmBase : d[f]._labels[1].position - d[f].viewportMinimum) *
                                    ...
                                    (E = d[f].logarithmic
                                        ? (1 < k ? (Math.log(k) / d[f].conversionParameters.lnLogarithmBase) * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1
                                        : (0 < k ? k * Math.abs(d[f].conversionParameters.pixelPerUnit) : 0) + d[f].lineCoordinates.x1));
                    for (f = 0; f < n.length; f++) "axisY" === n[f].type && (n[f].calculateValueToPixelConversionParameters(), n[f].calculateBreaksSizeInValues());
                    if (0 < v) {
                        if (a && 0 < a.length) for (f = 0; f < a.length; f++) r = M[v - 1][f] === M[v][f] ? !0 : !1;
                        else r = !0;
                        if (d && 0 < d.length) for (f = 0; f < d.length; f++) H = N[v - 1][f] === N[v][f] ? !0 : !1;
                        else H = !0;
                        if (b && 0 < b.length) for (f = 0; f < b.length; f++) I = O[v - 1][f] === O[v][f] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length) for (f = 0; f < c.length; f++) L = Q[v - 1][f] === Q[v][f] ? !0 : !1;
                        else L = !0;
                    }
                    if (r && H && I && L) break;
                    v++;
                ...
                for (N = []; 4 > v; ) {
                    ...
                    if (a && 0 < a.length) for (F = [], f = U = 0; f < a.length; f++) F.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateWidth() : 0)), (U += F[f]), (e += a[f] && !p.isNavigator ? a[f].margin : 0);
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length) for (z = [], f = V = 0; f < d.length; f++) z.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateWidth() : 0)), (V += z[f]), (W += d[f] ? d[f].margin : 0);
                    ...
                    if (b && 0 < b.length)
                        for (f = 0; f < b.length; f++)
                            (b[f].lineCoordinates = {}),
                                ...
                                b[f].labelAutoFit &&
                                    !u(C) &&
                                    (0 < !a.length && (k = 0 > b[f].labelAngle ? Math.max(k, C) : 0 === b[f].labelAngle ? Math.max(k, C / 2) : k),
                    ...
                    if (c && 0 < c.length)
                        for (f = 0; f < c.length; f++)
                            (c[f].lineCoordinates = {}),
                                ...
                                c[f] && c[f].labelAutoFit && !u(D) && (0 < !a.length && (k = 0 < c[f].labelAngle ? Math.max(k, D) : 0 === c[f].labelAngle ? Math.max(k, D / 2) : k), 0 < !d.length && (h -= y / 2)),
                    ...
                    if (b && 0 < b.length) for (q = [], f = S = 0; f < b.length; f++) q.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateHeight() : 0)), (S += q[f] + b[f].margin), (K += b[f].margin);
                    else q.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    E.push(q);
                    if (c && 0 < c.length) for (A = [], f = R = 0; f < c.length; f++) A.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)), (R += A[f]), ($ += c[f].margin);
                    ...
                    if (b && 0 < b.length)
                        for (f = b.length - 1; 0 <= f; f--)
                            (l = Math.round(g.y2)),
                                ...
                                (b[f].bounds = { x1: k, y1: l - (q[f] + X + b[f].margin), x2: h, y2: m - (X + b[f].margin), width: h - k, height: q[f] }),
                                b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width),
                                (X += q[f] + b[f].margin);
                    if (c && 0 < c.length)
                        for (f = c.length - 1; 0 <= f; f--)
                            c[f] &&
                                ...
                                (c[f].bounds = { x1: k, y1: l + (c[f].margin + G), x2: h, y2: m, width: h - k, height: R }),
                                c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width),
                                (G += A[f] + c[f].margin));
                    if (a && 0 < a.length)
                        for (f = 0; f < a.length; f++) {
                            ...
                            m =
                                b && 0 < b.length
                                    ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - S > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : g.y2 - S)
                    ...
                    if (d && 0 < d.length)
                        for (f = 0; f < d.length; f++) {
                            ...
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && ((h = 0 > b[K].labelAngle ? Math.max(h, C) : 0 === b[K].labelAngle ? Math.max(h, C / 2) : h), (k = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? h - V : k));
                    ...
                    if (0 < v) {
                        ...
                        if (b && 0 < b.length) for (f = 0; f < b.length; f++) I = E[v - 1][f] === E[v][f] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length) for (f = 0; f < c.length; f++) L = t[v - 1][f] === t[v][f] ? !0 : !1;
                        else L = !0;
                    }
                    if (r && H && I && L) break;
                    v++;
            ...
            for (var a = 0; a < this.stripLines.length; a++)
                if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
                    ...
                    this.stripLines[a].value = this.logarithmic
                        ? this.stripLines[a].value * Math.sqrt(Math.log(this.stripLines[a].endValue / this.stripLines[a].startValue) / Math.log(d))
        ...
        z.prototype.renderLabelsTicksAndTitle = function () {
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var b = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, l = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), m = this._labels.length - 1; 0 <= m; m--) {
                            ...
                            q.position > this.viewportMaximum ||
                                !(m === this._labels.length - 1 || k < (Math.log(l / q.position) * h) / e) ||
                                (b.push(q), (l = q.position), (k = q.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = b;
                    } else {
                        for (m = 0; m < this._labels.length; m++)
                            (q = this._labels[m]),
                                q.position < this.viewportMinimum || ((k = q.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (b += k));
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var b = [], p, l = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), m = this._labels.length - 1; 0 <= m; m--) {
                            ...
                            if (q.position < this.viewportMinimum) break;
                            q.position > this.viewportMaximum ||
                                !(m === this._labels.length - 1 || p < Math.log(l / q.position) * h) ||
                                (b.push(q), (l = q.position), (p = q.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = b;
                    } else {
                        for (m = 0; m < this._labels.length; m++)
                            (q = this._labels[m]),
                                q.position < this.viewportMinimum || ((p = q.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (c += p));
                    ...
                    (q = this._labels[m]),
                        q.position < this.viewportMinimum ||
                            ...
                            this.tickThickness &&
                                ...
                                this.ctx.stroke()),
                            0 === q.textBlock.angle
                                ? ((n.x -= q.textBlock.width / 2), (n.y = "inside" === this.labelPlacement ? n.y - (this.tickLength + q.textBlock.fontSize / 2) : n.y + this.tickLength + q.textBlock.fontSize / 2))
                                : ((n.x =
                                      "inside" === this.labelPlacement
                                          ? 0 > this.labelAngle
                                              ? n.x
                                              : n.x - q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                                          : n.x - (0 > this.labelAngle ? q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                                  (n.y =
                                      "inside" === this.labelPlacement
                                          ? 0 > this.labelAngle
                                              ? n.y - this.tickLength - 5
                                              : n.y - this.tickLength - Math.abs(q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5)
                                          : n.y + this.tickLength + Math.abs(0 > this.labelAngle ? q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5 : 5))),
                            (q.textBlock.x = n.x),
                            (q.textBlock.y = n.y));
                "inside" === this.labelPlacement &&
                    ...
                    (q = this._labels[m]),
                        q.position < this.viewportMinimum ||
                            ...
                            this.tickThickness &&
                                ...
                                this.ctx.stroke()),
                            0 === q.textBlock.angle
                                ? ((n.x -= q.textBlock.width / 2), (n.y = "inside" === this.labelPlacement ? n.y + this.labelFontSize / 2 + this.tickLength + 5 : n.y - (this.tickLength + q.textBlock.height - q.textBlock.fontSize / 2)))
                                : ((n.x =
                                      "inside" === this.labelPlacement
                                          ? 0 < this.labelAngle
                                              ? n.x
                                              : n.x - q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                                          : n.x +
                                            (q.textBlock.height - this.tickLength - this.labelFontSize) * Math.sin((Math.PI / 180) * this.labelAngle) -
                                            (0 < this.labelAngle ? q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) : 0)),
                                  (n.y =
                                      "inside" === this.labelPlacement
                                          ? 0 < this.labelAngle
                                              ? n.y + this.tickLength + 5
                                              : n.y - q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + this.tickLength + 5
                                          : n.y -
                                            (this.tickLength +
                                                ((q.textBlock.height - q.textBlock.fontSize / 2) * Math.cos((Math.PI / 180) * this.labelAngle) +
                                                    (0 < this.labelAngle ? q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) : 0))))),
                            (q.textBlock.x = n.x),
                            (q.textBlock.y = n.y));
                "inside" === this.labelPlacement &&
                    this.chart.addEventListener(
                    ...
                    (q = this._labels[m]),
                        q.position < this.viewportMinimum ||
                            ...
                            this.tickThickness &&
                                ...
                                this.ctx.stroke()),
                            0 === this.labelAngle
                                ? ((q.textBlock.y = n.y), (q.textBlock.x = "inside" === this.labelPlacement ? n.x + this.tickLength + 5 : n.x - q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - this.tickLength - 5))
                                : ((q.textBlock.y = "inside" === this.labelPlacement ? n.y : n.y - q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                                  (q.textBlock.x =
                                      "inside" === this.labelPlacement
                                          ? n.x + this.tickLength + 5
                                          : 0 < this.labelAngle
                                          ? n.x - q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - this.tickLength - 5
                                          : n.x - q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) + (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) - this.tickLength)));
                "inside" === this.labelPlacement &&
                    this.chart.addEventListener(
                        "dataAnimationIterationEnd",
                        function () {
                    ...
                    (q = this._labels[m]),
                        q.position < this.viewportMinimum ||
                            ...
                            this.tickThickness &&
                                ...
                                this.ctx.stroke()),
                            0 === this.labelAngle
                                ? ((q.textBlock.y = n.y), (q.textBlock.x = "inside" === this.labelPlacement ? n.x - q.textBlock.width - this.tickLength - 5 : n.x + this.tickLength + 5))
                                : ((q.textBlock.y =
                                      "inside" === this.labelPlacement
                                          ? n.y - q.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)
                                          : 0 > this.labelAngle
                                          ? n.y
                                          : n.y - (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.cos((Math.PI / 180) * this.labelAngle)),
                                  (q.textBlock.x =
                                      "inside" === this.labelPlacement
                                          ? n.x - q.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) - this.tickLength - 5
                                          : 0 < this.labelAngle
                                          ? n.x + (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.sin((Math.PI / 180) * this.labelAngle) + this.tickLength
                                          : n.x + this.tickLength + 5)));
                "inside" === this.labelPlacement &&
                    this.chart.addEventListener(
                        "dataAnimationIterationEnd",
            ...
            if ("inside" === this.labelPlacement)
                this.chart.addEventListener(
                    ...
                    function () {
                        for (m = 0; m < a._labels.length; m++)
                            (q = a._labels[m]), q.position < a.viewportMinimum || q.position > a.viewportMaximum || (d && 0 !== g++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), q.textBlock.render(!0), a.ctx.restore());
                    },
                    this
                );
            else for (m = 0; m < this._labels.length; m++) (q = this._labels[m]), q.position < this.viewportMinimum || q.position > this.viewportMaximum || (d && 0 !== g++ % 2 && this.labelAutoFit) || q.textBlock.render(!0);
        };
                                ...
                                "bottom" === this._position
                                    ? ((b.textBlock.maxWidth = this.options.stripLines[c].labelMaxWidth ? this.options.stripLines[c].labelMaxWidth : this.chart.plotArea.height - 3),
                                      ...
                                      a.x - b.textBlock.height > this.chart.plotArea.x1
                                          ...
                                          : ((b.textBlock.angle = 90), u(m.startValue) ? (a.x += b.textBlock.height - b.textBlock.fontSize / 2) : (a.x += b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3)),
                                      (a.y =
                ...
                for (var g = 0; g < e.length && !(d < e[g].startValue); g++)
                    a > e[g].endValue ||
                        (a <= e[g].startValue && d >= e[g].endValue
                            ...
                            : a >= e[g].startValue && d >= e[g].endValue
                            ? (b = (b / e[g].endValue) * a * Math.pow(e[g].size, Math.log(e[g].endValue / a) / Math.log(e[g].endValue / e[g].startValue)))
                            : a <= e[g].startValue && d <= e[g].endValue
                            ? (b = (b / d) * e[g].startValue * Math.pow(e[g].size, Math.log(d / e[g].startValue) / Math.log(e[g].endValue / e[g].startValue)))
                            : !c && a > e[g].startValue && d < e[g].endValue && (b = a * Math.pow(e[g].size, Math.log(d / a) / Math.log(e[g].endValue / e[g].startValue))));
            } else
                for (b = u(b) ? Math.abs(d - a) : b, g = 0; g < e.length && !(d < e[g].startValue); g++)
                    a > e[g].endValue ||
                        (a <= e[g].startValue && d >= e[g].endValue
                            ? (b = b - e[g].endValue + e[g].startValue + e[g].size)
                            : a > e[g].startValue && d >= e[g].endValue
                            ? (b = b - e[g].endValue + a + (e[g].size * (e[g].endValue - a)) / (e[g].endValue - e[g].startValue))
                            : a <= e[g].startValue && d < e[g].endValue
                            ? (b = b - d + e[g].startValue + (e[g].size * (d - e[g].startValue)) / (e[g].endValue - e[g].startValue))
                            : !c && a > e[g].startValue && d < e[g].endValue && (b = a + (e[g].size * (d - a)) / (e[g].endValue - e[g].startValue)));
            return b;
        };
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if (this.scaleBreaks)
                    for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++)
                        if (
                            ((!u(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) ||
                                (!u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue) ||
                                (!u(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue)) &&
                            ((!u(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue) ||
                                (!u(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[c].endValue) ||
                                (!u(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[c].endValue))
                        ) {
                    ...
                    "axisY" === this.type &&
                        ...
                        isFinite(e) || isFinite(g)
                            ? isFinite(e)
                                ? isFinite(g) || (g = e)
                                : (e = g)
                            : ((g = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval), (e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity)),
                        0 === e && 0 === g
                            ? ((g += 9), (e = 0))
                            : 0 === g - e
                            ? ((c = Math.min(Math.abs(0.01 * Math.abs(g)), 5)), (g += c), (e -= c))
                            : e > g
                            ? ((c = Math.min(0.01 * Math.abs(this.getApparentDifference(g, e, null, !0)), 5)), 0 <= g ? (e = g - c) : (g = isFinite(e) ? e + c : 0))
                            : ((c = Math.min(0.01 * Math.abs(this.getApparentDifference(e, g, null, !0)), 0.05)), 0 !== g && (g += c), 0 !== e && (e -= c)),
                ...
                if ("axisX" === this.type && b) {
                    this.intervalType ||
                        (c / 1 <= a
                            ...
                            : ((this.interval = c / (1 * S.yearDuration) <= a ? 1 : c / (2 * S.yearDuration) <= a ? 2 : c / (4 * S.yearDuration) <= a ? 4 : Math.floor(z.getNiceNumber(c / (a - 1), !0) / S.yearDuration)),
                ...
                if (null === this.minimum || null === this.maximum)
                    if (
                        ...
                        (this.intervalType = this.valueType = "number"),
                            null === this.minimum &&
                                ((this.minimum = "axisX" === this.type ? e - k / 2 : Math.floor(e / this.interval) * this.interval),
                            ...
                            null === this.maximum &&
                                ((this.maximum = "axisX" === this.type ? g + k / 2 : Math.ceil(g / this.interval) * this.interval),
        ...
        z.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            if (this.scaleBreaks)
                for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++)
                    if (
                        ((!u(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue) ||
                            (!u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[k].startValue) ||
                            (!u(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue)) &&
                        ((!u(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue) ||
                            (!u(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[k].endValue) ||
                            (!u(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue))
                    ) {
            ...
            "axisX" === this.type
                ? ((c = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
                  ...
                  1 === e / c && ((k = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval)), (e *= k), (c /= k)),
                ...
                : "axisY" === this.type &&
                  ...
                  1 === c && 1 === e
                      ...
                      : 1 === e / c
                      ? ((k = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), (e *= k), (c /= k))
                      : c > e
                      ? ((k = Math.min((c / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), 1 <= e ? (c = e / k) : (e = c * k))
                      : ((k = Math.min((e / c) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= k), 1 !== c && (c /= k)),
                  (g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / c > this.logarithmBase ? (e / c) * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase),
            ...
            1 === this.viewportMaximum &&
                ...
                this.options &&
                    ...
                    ((this.interval = z.getNiceExponent(Math.ceil(Math.log(k) / d) / (a - 1))), (b = z.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
            if (null === this.minimum || null === this.maximum)
                "axisX" === this.type
                    ...
                    : "axisY" === this.type &&
                      ...
                      isFinite(c) || isFinite(e)
                          ? 1 === c && 1 === e
                              ...
                              : 1 === e / c
                              ? ((k = Math.pow(this.logarithmBase, this.interval)), (e *= k), (c /= k))
                              : c > e
                              ? ((k = Math.min(0.01 * (c / e), 5)), 1 <= e ? (c = e / k) : (e = c * k))
                              : ((k = Math.min((e / c) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= k), 1 !== c && (c /= k))
                    ...
                    (this.intervalType = "number"),
                    null === this.minimum &&
                        ((this.minimum = "axisX" === this.type ? c / Math.sqrt(g) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(c) / d / this.interval))),
                    ...
                    null === this.maximum &&
                        ((this.maximum = "axisX" === this.type ? e * Math.sqrt(g) : Math.pow(this.logarithmBase, this.interval * Math.ceil(Math.log(e) / d / this.interval))),
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (
                        ...
                        "top" === this.scaleBreaks.parent._position
                            ...
                            : ((e = this.chart.plotArea.y2), (l = (this.chart.plotArea.y1 - q / 2 + 0.5) << 0), (a *= -1)),
                        (this.bounds = { x1: c - q / 2, y1: e, x2: k + q / 2, y2: l }),
                        this.ctx.moveTo(c, e),
                        ...
                        g = 0.5;
                        p = (l - m) / a / 3;
                        for (var n = 0; n < p; n++) this.ctx.bezierCurveTo(h + g * a, m + a, h + g * a, m + 2 * a, h, m + 3 * a), (m += 3 * a), (g *= -1);
                    ...
                    if (
                        ...
                        "left" === this.scaleBreaks.parent._position
                            ...
                            : ((c = this.chart.plotArea.x2), (k = (this.chart.plotArea.x1 - q / 2 + 0.5) << 0), (a *= -1)),
                        (this.bounds = { x1: c, y1: e - q / 2, x2: k, y2: l + q / 2 }),
                        this.ctx.moveTo(c, e),
                        ...
                        this.ctx.lineTo(h, m);
                        m += l - e;
                        for (n = 0; n < p + 1; n++) this.ctx.lineTo(h, m), (m += 2 * g * a), (h -= 2 * a), (g *= -1);
        ...
        fa.prototype.render = function (a, d) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    for (var r = 0; r < this.parent.dataSeries.length; r++) (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && ((f.dataSeries = this.parent.dataSeries[r]), null !== f.dataPoint.y && k.push(f));
                    f = null;
                    ...
                    if ("rangeBar" === k[0].dataSeries.type || "error" === k[0].dataSeries.type)
                        for (var f = Math.abs(a - this.parent.convertValueToPixel(k[r].dataPoint.y[0])), v = 0, n = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length) for (h = 0; h < k[n].dataPoint.y.length; h++) (v = Math.abs(a - this.parent.convertValueToPixel(k[n].dataPoint.y[h]))), v < f && ((f = v), (r = n));
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[r].type || "error" === this.parent.dataSeries[r].type) {
                            ...
                            l.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.y[b] })
                                : u(this.options.label)
                                ? ba(h.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            l.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.y })
                                : u(this.options.label)
                                ? ba(h.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            l.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: t })
                                : u(this.options.label)
                        ...
                        if (t) {
                            if ("axisX" === this.parent.type)
                                for (n = this.parent.convertPixelToValue({ y: d }), f = null, r = 0; r < this.parent.dataSeries.length; r++)
                                    (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) &&
                                        0 <= f.index &&
                                        (l.text = this.labelFormatter
                                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.x })
                                            : u(this.options.label)
                                            ? f.dataPoint.label
                                            : this.label);
                        } else
                            "dateTime" === this.parent.valueType
                                ? (l.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.x })
                                      : u(this.options.label)
                                      ? Ca(h.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                                : "number" === this.parent.valueType &&
                                  (l.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.x })
                                      : u(this.options.label)
                                      ? ba(h.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        l.y = g + l.fontSize / 2 - l.measureText().height / 2 + 2;
                        l.y - l.fontSize / 2 < this.chart.bounds.y1
                            ? (l.y = this.chart.bounds.y1 + l.fontSize / 2 + 2)
                            : l.y + l.measureText().height - l.fontSize / 2 > this.chart.bounds.y2 && (l.y = this.chart.bounds.y2 - l.measureText().height + l.fontSize / 2);
                    ...
                    for (r = 0; r < this.parent.dataSeries.length; r++) (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && ((f.dataSeries = this.parent.dataSeries[r]), null !== f.dataPoint.y && k.push(f));
                    if (0 === k.length) return;
                    k.sort(function (a, b) {
                        return a.distance - b.distance;
                    });
                    ...
                    r = 0;
                    if (
                        "rangeColumn" === k[0].dataSeries.type ||
                        "rangeArea" === k[0].dataSeries.type ||
                        "error" === k[0].dataSeries.type ||
                        "rangeSplineArea" === k[0].dataSeries.type ||
                        "candlestick" === k[0].dataSeries.type ||
                        "ohlc" === k[0].dataSeries.type ||
                        "boxAndWhisker" === k[0].dataSeries.type
                    )
                        for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y[0])), n = v = 0; n < k.length; n++)
                            if (k[n].dataPoint.y && k[n].dataPoint.y.length) for (h = 0; h < k[n].dataPoint.y.length; h++) (v = Math.abs(d - this.parent.convertValueToPixel(k[n].dataPoint.y[h]))), v < f && ((f = v), (r = n));
                    ...
                    if (
                        ...
                        for (n = v = 0; n < h.dataPoint.y.length; n++) (v = Math.abs(d - this.parent.convertValueToPixel(h.dataPoint.y[n]))), v < f && ((f = v), (b = n));
                        k = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(h.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(h.dataPoint.y[b]) << 0;
                        l.text = this.labelFormatter
                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.y[b] })
                            : u(this.options.label)
                        ...
                        "waterfall" === this.parent.dataSeries[r].type
                            ? ((k =
                                  1 === p.lineWidth % 2
                                      ? (this.parent.convertValueToPixel(h.dataSeries.dataPointEOs[h.index].cumulativeSum) << 0) + 0.5
                                      : this.parent.convertValueToPixel(h.dataSeries.dataPointEOs[h.index].cumulativeSum) << 0),
                              (l.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataSeries.dataPointEOs[h.index].cumulativeSum })
                                  : u(this.options.label)
                                  ? ba(h.dataSeries.dataPointEOs[h.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label))
                            : ((k = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(h.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(h.dataPoint.y) << 0),
                              (l.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: h.dataPoint.y })
                ...
                ("bottom" === this.parent._position || "top" === this.parent._position) &&
                    ...
                    (0 < m && (p.moveTo(b, e), p.lineTo(c, g), p.stroke()), p.restore(), !u(l.text) && ("number" === typeof l.text.valueOf() || 0 < l.text.length) && l.render(!0));
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    ...
                    (e = g = k = 1 === p.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (c = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: e - m / 2, x2: c, y2: g + m / 2 });
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        t = !1;
                        if (this.parent.labels)
                        ...
                        if (t) {
                            if ("axisX" === this.parent.type)
                                for (n = this.parent.convertPixelToValue({ y: d }), f = null, r = 0; r < this.parent.dataSeries.length; r++)
                                    (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) &&
                                        0 <= f.index &&
                                        (l.text = this.labelFormatter
                                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) })
                                            : u(this.options.label)
                                            ? f.dataPoint.label
                                            : this.label);
                        } else
                            "dateTime" === this.parent.valueType
                                ? (l.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(d) })
                                      : u(this.options.label)
                                      ? Ca(this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                                : "number" === this.parent.valueType &&
                                  (l.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(d) })
                                      : u(this.options.label)
                                      ? ba(this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            (l.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: this.parent.convertPixelToValue(a) })
                                : u(this.options.label)
                                ? ba(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                                : this.label),
                                (l.x = b - l.measureText().width / 2),
                                l.x + l.width > this.chart.bounds.x2 && (l.x = this.chart.bounds.x2 - l.width),
                                l.x < this.chart.bounds.x1 && (l.x = this.chart.bounds.x1),
                    ...
                    if (t) {
                        ...
                        "dateTime" === this.parent.valueType
                            ...
                            : "number" === this.parent.valueType &&
                              (l.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" })
                                  : u(this.options.label)
                                  ? ba(this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo)
                                  : this.label);
                    l.x = b - l.measureText().width / 2;
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex)
                            (c = e.dataPoints[this.currentDataPointIndex]),
                                ...
                                "waterfall" === e.type && ((m.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue), (m.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum));
                        else {
                            if (
                                !this.enabled ||
                                ("line" !== e.type &&
                            ...
                            if (m.dataSeries.axisY)
                                if (0 < m.dataPoint.y.length) {
                                    ...
                                    "column" === e.type || "bar" === e.type
                                        ? 0 > m.dataPoint.y
                                            ? 0 > m.dataSeries.axisY.viewportMinimum && m.dataSeries.axisY.viewportMaximum >= m.dataPoint.y && g.push(m)
                                            : m.dataSeries.axisY.viewportMinimum <= m.dataPoint.y && 0 <= m.dataSeries.axisY.viewportMaximum && g.push(m)
                                        : "bubble" === e.type
                                        ? ((b = this.chart._eventManager.objectMap[e.dataPointIds[m.index]].size / 2),
                                          m.dataPoint.y >= m.dataSeries.axisY.viewportMinimum - b && m.dataPoint.y <= m.dataSeries.axisY.viewportMaximum + b && g.push(m))
                                        : "waterfall" === e.type
                                        ? ((b = 0),
                                        ...
                                        : (0 <= m.dataSeries.type.indexOf("100") ||
                                              ...
                                              "stackedBar" === e.type ||
                                              (m.dataPoint.y >= m.dataSeries.axisY.viewportMinimum && m.dataPoint.y <= m.dataSeries.axisY.viewportMaximum)) &&
                                          g.push(m);
                            else g.push(m);
                    }
                }
                        ...
                        if (((b = ""), (b = this.getToolTipInnerHTML({ entries: g })), null !== b)) {
                                    ...
                                    (this.borderColor =
                                        "waterfall" === g[0].dataSeries.type
                                            ...
                                            : (this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.options.borderColor
                                                  ...
                                                  : g[0].dataSeries.color
                                                  ? g[0].dataSeries.color
                                                  : g[0].dataSeries._colorSet[g[0].index % g[0].dataSeries._colorSet.length])),
                            ...
                            d =
                                ...
                                ("line" !== g[0].dataSeries.type &&
                                    ...
                                    ? "bar" === g[0].dataSeries.type || "rangeBar" === g[0].dataSeries.type || "stackedBar" === g[0].dataSeries.type || "stackedBar100" === g[0].dataSeries.type
                        ...
                        "rangeSplineArea" === c.type
                            ? ((g = c.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                              ...
                              "undefined" !== typeof e.y2 &&
                                  ...
                                  ia.drawMarkers([g])))
                            : "bubble" === c.type
                            ? ((g = c.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (g.size = e.size), (g.color = "white"), (g.borderColor = "white"), (d.globalAlpha = 0.3), ia.drawMarkers([g]), (d.globalAlpha = 1))
                            : "column" === c.type ||
                            ...
                            ? ja(d, e.center, e.radius, "white", c.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
                            ...
                            ? (d.save(),
                              ...
                              d.restore(),
                              (d.globalAlpha = 1))
                            : "error" === c.type && E(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
                }
            }
            d.restore();
            d.globalAlpha = 1;
                    ...
                    (b = a[h].dataSeries),
                        ...
                        0 === h &&
                            ...
                            (this.chart.axisX && 0 < this.chart.axisX.length
                                ? (m += "undefined" !== typeof this.chart.axisX[0].labels[c.x] ? this.chart.axisX[0].labels[c.x] : "{x}")
                                : this.chart.axisX2 && 0 < this.chart.axisX2.length && (m += "undefined" !== typeof this.chart.axisX2[0].labels[c.x] ? this.chart.axisX2[0].labels[c.x] : "{x}"),
                            (m += "</br>"),
                        ...
                        null === c.toolTipContent ||
                            ...
                            "waterfall" === b.type
                                ? (this.chart.axisX && 1 < this.chart.axisX.length && (g += p != b.axisXIndex ? (b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>") : ""),
                                  (g += c.toolTipContent
                                      ? c.toolTipContent
                                      : b.toolTipContent
                                      ? b.toolTipContent
                            ...
                            null === d && (d = ""),
                            !0 === this.reversed
                                ? ((d = this.chart.replaceKeywordsWithValue(g, c, b, e) + d), h < a.length - 1 && (d = "</br>" + d))
                                : ((d += this.chart.replaceKeywordsWithValue(g, c, b, e)), h < a.length - 1 && (d += "</br>")));
                null !== d && (d = m + d);
            } else {
                b = a[0].dataSeries;
                c = a[0].dataPoint;
                ...
                if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c])
                    if (((c = this.objectMap[c]), "dataPoint" === c.objectType)) {
                        ...
                        "legendItem" === c.objectType &&
                            ...
                            (c.eventParameter = { x: b.x, y: b.y, dataSeries: e.options, dataPoint: g, dataPointIndex: c.dataPointIndex, dataSeriesIndex: c.dataSeriesIndex, chart: this.chart }),
                    ...
                    if (b) {
                        ...
                        "circle" === c
                            ? (b.moveTo(a, d),
                              ...
                              g && b.fill(),
                              l && (h ? b.stroke() : ((p = b.globalAlpha), (b.globalAlpha = 0.15), (b.strokeStyle = "black"), b.stroke(), (b.globalAlpha = p))))
                            : "square" === c
                            ? (b.beginPath(), b.rect(a - e / 2, d - e / 2, e, e), g && b.fill(), l && (h ? b.stroke() : ((p = b.globalAlpha), (b.globalAlpha = 0.15), (b.strokeStyle = "black"), b.stroke(), (b.globalAlpha = p))))
                            : "triangle" === c
                            ? (b.beginPath(),
