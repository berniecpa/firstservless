      ...
      const columns = [
     
        {
          ...
          render: (text, record) => (
            ...
            <a href="#" data-bs-toggle="modal" data-target="#project-details">{text} </a></>
            ),
        ...
        },
        {
          ...
          render: (text, record) => (
            <><a href="#" data-bs-toggle="modal" data-target="#system-user">{text}</a></>
            ),
          sorter: (a, b) => a.projectStatus.length - b.projectStatus.length,
        },
        {
           ...
           <>
            <div className="pipeline-small flat pipeline-project">
                <a className={record.text1} data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline, stage: plan">&nbsp;
                  <span className="stretched-link" data-bs-toggle="modal" data-target="#project-details"></span>
                </a>
							...
							<div className="col text-end">
								<ul className="list-inline-item pl-0">
					                ...
					                <li className="list-inline-item">
					                    <button className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-bs-toggle="modal" data-target="#add_project">New Project</button>
					                </li>
					            </ul>
							</div>
						</div>
