                   ...
                   <div className="row mobile-view">
                     <div className="top-action-left">
                       <div className="float-start">
                         ...
                         <button type="button" title="Refresh" data-bs-toggle="tooltip" className="btn btn-white d-md-inline-block mb-3"><i className="fa fa-refresh" /></button>
                       </div>
        ...
        <div className="modal-dialog">
          ...
          <div className="modal-content">
            ...
            <div className="modal-header">
              ...
              <button type="button" className="btn-close xs-close" data-bs-dismiss="modal"></button>
            </div>
            {/* Modal body */}
