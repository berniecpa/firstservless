        ...
        <div className="page-header py-3 mb-0">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-end ml-auto">
              <a href="#" data-bs-toggle="modal" data-target="#compose-mail" className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded"><i className="fa fa-plus" /> Compose</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
