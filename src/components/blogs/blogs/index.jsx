        ...
        <div className="content container-fluid">
            ...
            <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
                ...
                <div className="blog-image">
                    ...
                    <i className="feather-eye me-1" /> 225
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="edit-delete-btn">
                        <Link to="/edit-blog" className="text-success">
                    ...
                    <div className="text-end inactive-style">
                        ...
                        >
                        <i className="feather-eye-off me-1" /> Inactive
                        </a>
                    </div>
                    </div>
                </div>
            ...
            <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
                ...
                <div className="blog-image">
                    ...
                    <div className="blog-views">
                    <i className="feather-eye me-1" /> 132
                    </div>
                </div>
                <div className="blog-content">
                    <ul className="entry-meta meta-item">
            ...
            <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
                ...
                <div className="blog-image">
                    ...
                    <div className="blog-views">
                    <i className="feather-eye me-1" /> 344
                    </div>
                </div>
                <div className="blog-content">
                    <ul className="entry-meta meta-item">
            ...
            <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
                ...
                <div className="blog-image">
                    ...
                    <div className="blog-views">
                    <i className="feather-eye me-1" /> 215
                    </div>
                </div>
                <div className="blog-content">
                    <ul className="entry-meta meta-item">
            ...
            <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
                ...
                <div className="blog-image">
                    ...
                    <div className="blog-views">
                    <i className="feather-eye me-1" /> 285
                    </div>
                </div>
                <div className="blog-content">
                    <ul className="entry-meta meta-item">
            ...
            <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
                ...
                <div className="blog-image">
                    ...
                    <div className="blog-views">
                    <i className="feather-eye me-1" /> 654
                    </div>
                </div>
                <div className="blog-content">
                    <ul className="entry-meta meta-item">
            ...
            <div className="col-md-12">
                ...
                <ul className="pagination mb-0">
                    ...
                    <a className="page-link" href="#" tabIndex={-1}>
                        <i className="feather-chevron-left me-2" />
                        Previous
                    </a>
                    </li>
