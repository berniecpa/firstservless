                    ...
                    <div className="row">
                        ...
                        <ul className="app-listing">
                            ...
                            <div className="multipleSelection">
                                ...
                                <p className="mb-0">
                                    <i
                                    className="feather-user-plus me-1 select-icon"
                                    />{" "}
                                    Select User
                                </p>
                            ...
                            <div className="multipleSelection">
                                ...
                                <p className="mb-0">
                                    <i
                                    className="feather-calendar me-1 select-icon"
                                    />{" "}
                                    Select Date
                                </p>
                                <span className="down-icon">
                            ...
                            <div className="multipleSelection">
                                ...
                                <p className="mb-0">
                                    <i
                                    className="feather-book-open me-1 select-icon"
                                    />{" "}
                                    Select Status
                                </p>
                                <span className="down-icon">
                            ...
                            <div className="multipleSelection">
                                ...
                                <p className="mb-0">
                                    <i
                                    className="feather-bookmark me-1 select-icon"
                                    />{" "}
                                    By Category
                                </p>
                                <span className="down-icon">
                    ...
                    <div className="invoices-main-tabs">
                        ...
                        <div className="col-lg-4 col-md-4">
                            ...
                            <Link to="/add-invoice" className="btn">
                                <i className="feather-plus-circle me-1 select-icon" /> New Invoice
                            </Link>
                            </div>
                        </div>
                        </div>
