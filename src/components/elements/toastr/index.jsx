...
const Toastr = () => {
  ...
  const progessBar = () => {
    ...
    setTimeout(function () { canDismiss = true; }, 3000);
  }
  const clearToast = () => {
  ...
  const show5 = () => {
    var duration = 5;
    alertify.set('notifier', 'position', 'top-right');
    var msg = alertify.message('Auto-dismiss in ' + duration + ' seconds.', 5, function () { clearInterval(interval); });
  ...
  const hide3 = () => {
    var duration = 3;
    alertify.set('notifier', 'position', 'top-right');
    var msg = alertify.message('Auto-dismiss in ' + duration + ' seconds.', 3, function () { clearInterval(interval); });
    var interval = setInterval(function () {
      msg.setContent('Auto-dismiss in ' + (--duration) + ' seconds.');
    }, 1000);
  }
  ...
  const sticky = () => {
    ...
    notification.ondismiss = function () { return canDismiss; };
    setTimeout(function () { canDismiss = true; }, 100000);
  }
  return (
    <>
      {/* Page Wrapper */}
