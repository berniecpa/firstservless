                ...
                <div className="col text-end">
                  <ul className="list-inline-item pl-0">
                    ...
                    <li className="list-inline-item">
                      <button className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-bs-toggle="modal" data-target="#add_task">New Task</button>
                    </li>
                  </ul>
                </div>
              </div>
